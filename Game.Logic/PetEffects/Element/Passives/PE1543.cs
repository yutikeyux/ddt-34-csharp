...
{
    public class PE1543 : BasePetEffect
    {
        private int m_type;
        private int m_count;
        ...
        public PE1543(int count, int probability, int type, int skillId, int delay, string elementID)
          : base(ePetEffectType.PE1543, elementID)
        {
            m_count = count;
            m_coldDown = count;
        ...
        {
            PE1543 effect = living.PetEffectList.GetOfType(ePetEffectType.PE1543) as PE1543;
            if (effect != null)
            {

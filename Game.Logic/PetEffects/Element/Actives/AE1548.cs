...
{
    public class AE1548 : BasePetEffect
    {
        ...
        public AE1548(int count, int probability, int type, int skillId, int delay, string elementID)
            : base(ePetEffectType.AE1548, elementID)
        {
            m_count = count;
            m_coldDown = count;
        ...
        {
            AE1548 effect = living.PetEffectList.GetOfType(ePetEffectType.AE1548) as AE1548;
            if (effect != null)
            {

...
namespace Game.Logic.PetEffects.Element.Actives
{
    public class AE1194 : BasePetEffect
    {
        ...
        {
            if (living.PetEffectList.GetOfType(ePetEffectType.AE1194) is AE1194 effect)
            {
        ...
        private void player_AfterBuffSkillPetByLiving(Player player)
        {
            ...
            {
                player.AddPetEffect(new CE1194(1, m_probability, m_type, m_currentId, m_delay, ElementInfo.ID.ToString()), 0);

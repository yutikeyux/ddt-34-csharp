...
namespace Game.Logic.PetEffects.Element.Actives
{
    public class AE1554 : BasePetEffect
    {
        ...
        {
            AE1554 effect = living.PetEffectList.GetOfType(ePetEffectType.AE1554) as AE1554;
            if (effect != null)
            {
        ...
        {
            new CE1554(2, m_probability, m_type, m_currentId, m_delay, ElementInfo.ID.ToString()).Start(player);
        }

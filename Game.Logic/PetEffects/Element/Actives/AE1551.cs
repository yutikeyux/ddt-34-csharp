...
{
    public class AE1551 : BasePetEffect
    {
        ...
        public AE1551(int count, int probability, int type, int skillId, int delay, string elementID)
            : base(ePetEffectType.AE1551, elementID)
        {
            m_count = count;
            m_coldDown = count;
        ...
        {
            AE1551 effect = living.PetEffectList.GetOfType(ePetEffectType.AE1551) as AE1551;
            if (effect != null)
            {

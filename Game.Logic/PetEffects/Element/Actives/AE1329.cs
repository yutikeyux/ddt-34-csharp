...
{
    public class AE1329 : BasePetEffect
    {
        ...
        public AE1329(int count, int probability, int type, int skillId, int delay, string elementID)
            : base(ePetEffectType.E1329, elementID)
        {
            m_count = count;
            m_coldDown = count;
        ...
        {
            AE1329 effect = living.PetEffectList.GetOfType(ePetEffectType.E1329) as AE1329;
            if (effect != null)
            {

...
{
    public class AE1550 : BasePetEffect
    {
        ...
        public AE1550(int count, int probability, int type, int skillId, int delay, string elementID)
            : base(ePetEffectType.AE1550, elementID)
        {
            m_count = count;
            m_coldDown = count;
        ...
        {
            AE1550 effect = living.PetEffectList.GetOfType(ePetEffectType.AE1550) as AE1550;
            if (effect != null)
            {

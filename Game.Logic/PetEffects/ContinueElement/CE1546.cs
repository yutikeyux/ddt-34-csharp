...
{
    public class CE1546 : BasePetEffect
    {
        private int m_type;
        private int m_count;
        ...
        public CE1546(int count, int probability, int type, int skillId, int delay, string elementID)
          : base(ePetEffectType.CE1546, elementID)
        {
            m_count = count;
            m_coldDown = count;
        ...
        {
            CE1546 effect = living.PetEffectList.GetOfType(ePetEffectType.CE1546) as CE1546;
            if (effect != null)
            {

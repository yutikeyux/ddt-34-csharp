...
{
    public class CE1366 : BasePetEffect
    {
        ...
        public CE1366(int count, int probability, int type, int skillId, int delay, string elementID)
            : base(ePetEffectType.CE1366, elementID)
        {
            m_count = count;
            m_coldDown = count;
        ...
        {
            CE1366 effect = living.PetEffectList.GetOfType(ePetEffectType.CE1366) as CE1366;
            if (effect != null)
            {

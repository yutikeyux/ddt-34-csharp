...
{
    public class CE1367 : BasePetEffect
    {
        ...
        public CE1367(int count, int probability, int type, int skillId, int delay, string elementID)
            : base(ePetEffectType.CE1367, elementID)
        {
            m_count = count;
            m_coldDown = count;
        ...
        {
            CE1367 effect = living.PetEffectList.GetOfType(ePetEffectType.CE1367) as CE1367;
            if (effect != null)
            {

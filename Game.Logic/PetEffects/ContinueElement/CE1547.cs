...
{
    public class CE1547 : BasePetEffect
    {
        private int m_type;
        private int m_count;
        ...
        public CE1547(int count, int probability, int type, int skillId, int delay, string elementID)
          : base(ePetEffectType.CE1547, elementID)
        {
            m_count = count;
            m_coldDown = count;
        ...
        {
            CE1547 effect = living.PetEffectList.GetOfType(ePetEffectType.CE1547) as CE1547;
            if (effect != null)
            {

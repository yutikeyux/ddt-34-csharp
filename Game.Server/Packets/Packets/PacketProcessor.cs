    ...
    public class PacketProcessor
    {
        ...
        public void HandlePacket(GSPacketIn packet)
        {
			...
			try
			{
				...
				if (m_client != null && packet != null && m_client.TcpEndpoint != "not connected" && (m_client.Player != null || packet.Code == 1))
				{ //şimdilik normal gibi işler yolunda  bi saldırsınlar :D
					if (m_client.Player != null && m_client.Player.PlayerCharacter.NickName == "tester5656")
					{

...
namespace Game.Server.Packets.Client
{
    ...
    internal class MarrySceneChangeHandler : IPacketHandler
    {
        public int HandlePacket(GameClient client, GSPacketIn packet)
        {
            ...
            GSPacketIn packet2 = new(244, client.Player.PlayerCharacter.ID);
            ...
            foreach (GamePlayer gamePlayer in array)
            {
                ...
                {
                    _ = gamePlayer.Out.SendPlayerEnterMarryRoom(client.Player);
                    _ = client.Player.Out.SendPlayerEnterMarryRoom(gamePlayer);
                }
            }
            return 0;
        }

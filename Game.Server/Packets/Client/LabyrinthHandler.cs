                ...
                case LabyrinthPackageType.DOUBLE_REWARD:
                    {
                        ...
                        _ = client.Player.Out.SendLabyrinthUpdataInfo(iD, userLabyrinthInfo);
                        break;
                    }
                ...
                case LabyrinthPackageType.CLEAN_OUT:
                    {
                        ...
                        else
                        {
                            ...
                            _ = client.Player.RemoveGiftToken(warriorFamRaidDDTPrice);
                ...
                case LabyrinthPackageType.SPEEDED_UP_CLEAN_OUT:
                    {
                        ...
                        if (client.Player.MoneyDirect(value2, IsAntiMult: false, false, true))
                        {

    ...
    public class ItemStrengthenHandler : IPacketHandler
    {
        ...
        public int HandlePacket(GameClient client, GSPacketIn packet)
        {
            ...
            if (item != null && item.Template.CanStrengthen && item.Count == 1)
            {
                ...
                if (client.Player.PlayerCharacter.Grade < 17 && item.StrengthenLevel >= 8 && item.Template.CategoryID == 7)
                {
                    client.Player.SendMessage("Silah güçlendirme limitine eriştin. 17. seviyeye ulaş!");
                    return 0;
                }
                if (client.Player.PlayerCharacter.Grade < 20 && item.StrengthenLevel >= 9 && item.Template.CategoryID == 7)
                {
                    client.Player.SendMessage("Silah güçlendirme limitine eriştin. 20. seviyeye ulaş!");
                    return 0;
                }
                if (client.Player.PlayerCharacter.Grade < 25 && item.StrengthenLevel >= 10 && item.Template.CategoryID == 7)
                {
                    client.Player.SendMessage("Silah güçlendirme limitine eriştin. 25. seviyeye ulaş!");
                    return 0;
                }
                bool flag19 = client.Player.PlayerCharacter.Grade < 29 && item.StrengthenLevel >= 11 && item.Template.CategoryID == 7;
                if (flag19)
                {
                    client.Player.SendMessage("Silah güçlendirme limitine eriştin. 29. seviyeye ulaş!");
                    return 0;
                }
                bool flag20 = client.Player.PlayerCharacter.Grade < 30 && item.StrengthenLevel >= 12 && item.Template.CategoryID == 7;
                if (flag20)
                {
                    client.Player.SendMessage("Silah güçlendirme limitine eriştin. 30. seviyeye ulaş!");
                    return 0;
                }
                bool flag21 = client.Player.PlayerCharacter.Grade < 10 && item.StrengthenLevel >= 7 && item.Template.CategoryID == 1;
                if (flag21)
                {
                    client.Player.SendMessage("Şapka güçlendirme limitine eriştin. 10. seviyeye ulaş!");
                    return 0;
                }
                bool flag22 = client.Player.PlayerCharacter.Grade < 13 && item.StrengthenLevel >= 8 && item.Template.CategoryID == 1;
                if (flag22)
                {
                    client.Player.SendMessage("Şapka güçlendirme limitine eriştin. 13. seviyeye ulaş!");
                    return 0;
                }
                bool flag23 = client.Player.PlayerCharacter.Grade < 15 && item.StrengthenLevel >= 9 && item.Template.CategoryID == 1;
                if (flag23)
                {
                    client.Player.SendMessage("Şapka güçlendirme limitine eriştin. 15. seviyeye ulaş!");
                    return 0;
                }
                bool flag24 = client.Player.PlayerCharacter.Grade < 17 && item.StrengthenLevel >= 10 && item.Template.CategoryID == 1;
                if (flag24)
                {
                    client.Player.SendMessage("Şapka güçlendirme limitine eriştin. 17. seviyeye ulaş!");
                    return 0;
                }
                bool flag25 = client.Player.PlayerCharacter.Grade < 19 && item.StrengthenLevel >= 11 && item.Template.CategoryID == 1;
                if (flag25)
                {
                    client.Player.SendMessage("Şapka güçlendirme limitine eriştin. 19. seviyeye ulaş!");
                    return 0;
                }
                bool flag26 = client.Player.PlayerCharacter.Grade < 20 && item.StrengthenLevel >= 12 && item.Template.CategoryID == 1;
                if (flag26)
                {
                    client.Player.SendMessage("Şapka güçlendirme limitine eriştin. 20. seviyeye ulaş!");
                    return 0;
                }
                bool flag27 = client.Player.PlayerCharacter.Grade < 10 && item.StrengthenLevel >= 7 && item.Template.CategoryID == 5;
                if (flag27)
                {
                    client.Player.SendMessage("Kıyafet güçlendirme limitine eriştin. 10. seviyeye ulaş!");
                    return 0;
                }
                bool flag28 = client.Player.PlayerCharacter.Grade < 13 && item.StrengthenLevel >= 8 && item.Template.CategoryID == 5;
                if (flag28)
                {
                    client.Player.SendMessage("Kıyafet güçlendirme limitine eriştin. 13. seviyeye ulaş!");
                    return 0;
                }
                bool flag29 = client.Player.PlayerCharacter.Grade < 15 && item.StrengthenLevel >= 9 && item.Template.CategoryID == 5;
                if (flag29)
                {
                    client.Player.SendMessage("Kıyafet güçlendirme limitine eriştin. 15. seviyeye ulaş!");
                    return 0;
                }
                bool flag30 = client.Player.PlayerCharacter.Grade < 17 && item.StrengthenLevel >= 10 && item.Template.CategoryID == 5;
                if (flag30)
                {
                    client.Player.SendMessage("Kıyafet güçlendirme limitine eriştin. 17. seviyeye ulaş!");
                    return 0;
                }
                bool flag31 = client.Player.PlayerCharacter.Grade < 19 && item.StrengthenLevel >= 11 && item.Template.CategoryID == 5;
                if (flag31)
                {
                    client.Player.SendMessage("Kıyafet güçlendirme limitine eriştin. 19. seviyeye ulaş!");
                    return 0;
                }
                bool flag32 = client.Player.PlayerCharacter.Grade < 20 && item.StrengthenLevel >= 12 && item.Template.CategoryID == 5;
                if (flag32)
                {

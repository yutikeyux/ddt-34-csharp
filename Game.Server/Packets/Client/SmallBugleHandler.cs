    ...
    public class SmallBugleHandler : IPacketHandler
    {
        public int HandlePacket(GameClient client, GSPacketIn packet)
        {
            ...
            if (itemByCategoryID != null)
            {
                ...
                {
                    _ = client.Out.SendMessage(eMessageType.ChatERROR, LanguageMgr.GetTranslation("2 saniye sonra  küçük hoparlör mesajı gönderilebilir."));
                    return 1;
                }
                GSPacketIn gSPacketIn = new(71);

...
namespace Game.Server.Packets.Client
{
    ...
    public class GameDataHandler : IPacketHandler
    {
        public int HandlePacket(GameClient client, GSPacketIn packet)
        {
            ...
            {
                packet.Parameter1 = UseBackupID(client.Player.CurrentRoom.RoomType) ? client.Player.TempGameId : client.Player.GamePlayerId;
                if (client.Player.CurrentRoom.Game == null)
                {
                    ...
                    if (pkg == 98)
                    {
                        ...
                        GSPacketIn gSPacketIn2 = new((byte)ePackageTypeLogic.GAME_CMD, gSPacketIn.Parameter1)
                        {
                            Parameter1 = gSPacketIn.Parameter1
                        };
                    ...
                    else if (pkg == (int)eTankCmdType.REPORT_COMMAND)
                    {

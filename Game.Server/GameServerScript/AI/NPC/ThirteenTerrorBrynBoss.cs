...
namespace GameServerScript.AI.NPC
{
	public class ThirteenTerrorBrynBoss : ABrain
	{
		...
		{
			int num = base.Game.Random.Next(0, ThirteenTerrorBrynBoss.KillAttackChat.Length);
			base.Body.Say(ThirteenTerrorBrynBoss.KillAttackChat[num], 1, 1000);
		...
		{
			int num = base.Game.Random.Next(0, ThirteenTerrorBrynBoss.ShootChat.Length);
			base.Body.Say(ThirteenTerrorBrynBoss.ShootChat[num], 1, 0);
		...
		public override void OnKillPlayerSay()
		{
			...
			int num = base.Game.Random.Next(0, ThirteenTerrorBrynBoss.KillPlayerChat.Length);
			base.Body.Say(ThirteenTerrorBrynBoss.KillPlayerChat[num], 1, 0, 2000);
		}

		public override void OnShootedSay()
		{
			int num = base.Game.Random.Next(0, ThirteenTerrorBrynBoss.ShootedChat.Length);
			if (this.isSay == 0 && base.Body.IsLiving)
			{
				base.Body.Say(ThirteenTerrorBrynBoss.ShootedChat[num], 1, 900, 0);
				this.isSay = 1;
			}
			if (!base.Body.IsLiving)
			{
				num = base.Game.Random.Next(0, ThirteenTerrorBrynBoss.DiedChat.Length);
				base.Body.Say(ThirteenTerrorBrynBoss.DiedChat[num], 1, 100, 2000);
			}
		}
	}
}

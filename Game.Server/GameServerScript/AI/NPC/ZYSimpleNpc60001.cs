...
namespace GameServerScript.AI.NPC
{
	public class ZYSimpleNpc60001 : ABrain
	{
		...
		public void HalfAttack()
		{
			...
			int num = base.Game.Random.Next(0, ZYSimpleNpc60001.SealChat.Length);
			base.Body.Say(ZYSimpleNpc60001.AllAttackChat[num], 1, 500);
		...
		public void Summon()
		{
			int num = base.Game.Random.Next(0, ZYSimpleNpc60001.CallChat.Length);
			base.Body.Say(ZYSimpleNpc60001.CallChat[num], 1, 0);
		...
		{
			int num = base.Game.Random.Next(0, ZYSimpleNpc60001.SealChat.Length);
			((SimpleBoss)base.Body).Say(ZYSimpleNpc60001.SealChat[num], 1, 0);
		...
		public void KillAttack(int fx, int tx)
		{
			...
			int num = base.Game.Random.Next(0, ZYSimpleNpc60001.KillAttackChat.Length);
			((SimpleBoss)base.Body).Say(ZYSimpleNpc60001.KillAttackChat[num], 1, 500);
			base.Body.PlayMovie("beatB", 2500, 0);

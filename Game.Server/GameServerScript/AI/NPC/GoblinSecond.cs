...
namespace GameServerScript.AI.NPC
{
	public class GoblinSecond : ABrain
	{
		...
		{
			int num = base.Game.Random.Next(0, GoblinSecond.KillAttackChat.Length);
			if (this.m_turn == 0)
			{
				base.Body.CurrentDamagePlus = 10f;
				base.Body.Say(GoblinSecond.KillAttackChat[num], 1, 13000);
			...
			{
				base.Body.CurrentDamagePlus = 10f;
				base.Body.Say(GoblinSecond.KillAttackChat[num], 1, 0);
		...
		private void NextAttack()
		{
			...
			{
				if (base.Body.ShootPoint(player.X, player.Y, 56, 1000, 10000, 1, 2.5f, 2000))
				{
				}
			}
		}

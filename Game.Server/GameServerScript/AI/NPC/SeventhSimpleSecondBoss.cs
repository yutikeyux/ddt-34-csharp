...
namespace GameServerScript.AI.NPC
{
	public class SeventhSimpleSecondBoss : ABrain
	{
		...
		{
			int num = base.Game.Random.Next(0, SeventhSimpleSecondBoss.KillAttackChat.Length);
			base.Body.Say(SeventhSimpleSecondBoss.KillAttackChat[num], 1, 0);
		...
		private void AttackingC()
		{
			...
			if (player != null)
			{
				...
				if (base.Body.ShootPoint(x, player.Y, 83, 1000, 10000, 1, 1.5f, 3300))
				{
		...
		{
			base.Body.MoveTo(1477, base.Body.Y, "run", 1000, "", 30, new LivingCallBack(this.PersonalAttack));
		}

		private void PersonalAttack()
		{
			base.Body.Direction = -base.Body.Direction;
			base.Body.PlayMovie("beatD", 2000, 8100);

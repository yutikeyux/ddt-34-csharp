...
namespace GameServerScript.AI.NPC
{
	public class ThirdHardShortNpcFirst : ABrain
	{
		...
		public override void OnBeginNewTurn()
		{
			...
			{
				string oneChat = ThirdHardShortNpcFirst.GetOneChat();
		...
		{
			int num = ThirdHardShortNpcFirst.random.Next(0, ThirdHardShortNpcFirst.listChat.Length);
			return ThirdHardShortNpcFirst.listChat[num];
		}
		...
		public static void LivingSay(List<Living> livings)
		{
			if (livings != null && livings.Count != 0)
			{
				...
				if (count <= 5)
				{
					num = ThirdHardShortNpcFirst.random.Next(0, 2);
				}
				else if (count > 5 && count <= 10)
				{
					num = ThirdHardShortNpcFirst.random.Next(1, 3);
				}
				else
				{
					num = ThirdHardShortNpcFirst.random.Next(1, 4);
				}
				if (num > 0)
				{

...
namespace GameServerScript.AI.NPC
{
	public class ThirdHardKingSecond : ABrain
	{
		...
		private void KillAttack(int fx, int tx)
		{
			...
			int num = base.Game.Random.Next(0, ThirdHardKingSecond.KillAttackChat.Length);
			base.Body.Say(ThirdHardKingSecond.KillAttackChat[num], 1, 1000);
		...
		private void Summon()
		{
			int num = base.Game.Random.Next(0, ThirdHardKingSecond.CallChat.Length);
			base.Body.Say(ThirdHardKingSecond.CallChat[num], 0, 3300);
		...
		private void NextAttack()
		{
			...
			int num = base.Game.Random.Next(0, ThirdHardKingSecond.ShootChat.Length);
			base.Body.Say(ThirdHardKingSecond.ShootChat[num], 0, 0);
			if (player != null)
			{

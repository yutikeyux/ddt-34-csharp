...
namespace GameServerScript.AI.NPC
{
	public class ThirdSimpleKingSecond : ABrain
	{
		...
		private void KillAttack(int fx, int tx)
		{
			...
			int num = base.Game.Random.Next(0, ThirdSimpleKingSecond.KillAttackChat.Length);
			base.Body.Say(ThirdSimpleKingSecond.KillAttackChat[num], 1, 1000);
		...
		private void Summon()
		{
			int num = base.Game.Random.Next(0, ThirdSimpleKingSecond.CallChat.Length);
			base.Body.Say(ThirdSimpleKingSecond.CallChat[num], 0, 3300);
		...
		private void NextAttack()
		{
			...
			int num = base.Game.Random.Next(0, ThirdSimpleKingSecond.ShootChat.Length);
			base.Body.Say(ThirdSimpleKingSecond.ShootChat[num], 0, 0);
			if (player != null)
			{

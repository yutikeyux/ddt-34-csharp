...
namespace GameServerScript.AI.NPC
{
	public class ThirteenTerrorNioBoss : ABrain
	{
		...
		private void KillAttack(int fx, int tx)
		{
			...
			int num = base.Game.Random.Next(0, ThirteenTerrorNioBoss.KillAttackChat.Length);
			base.Body.Say(ThirteenTerrorNioBoss.KillAttackChat[num], 1, 1000);
		...
		private void AllAttack()
		{
			...
			int num = base.Game.Random.Next(0, ThirteenTerrorNioBoss.AllAttackChat.Length);
			base.Body.Say(ThirteenTerrorNioBoss.AllAttackChat[num], 1, 0);
		...
		{
			int num = base.Game.Random.Next(0, ThirteenTerrorNioBoss.AddBooldChat.Length);
			base.Body.Say(ThirteenTerrorNioBoss.AddBooldChat[num], 1, 0);
		...
		private void NextAttack()
		{
			...
			int num = base.Game.Random.Next(0, ThirteenTerrorNioBoss.ShootChat.Length);
			base.Body.Say(ThirteenTerrorNioBoss.ShootChat[num], 1, 0);
			if (player != null)
			{

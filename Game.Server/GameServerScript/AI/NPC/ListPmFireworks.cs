...
namespace GameServerScript.AI.NPC
{
	public class ListPmFireworks : ABrain
	{
		...
		{
			int num = base.Game.Random.Next(0, ListPmFireworks.KillAttackChat.Length);
			if (this.m_turn == 0)
			{
				base.Body.CurrentDamagePlus = 10f;
				base.Body.Say(ListPmFireworks.KillAttackChat[num], 1, 13000);
			...
			{
				base.Body.CurrentDamagePlus = 10f;
				base.Body.Say(ListPmFireworks.KillAttackChat[num], 1, 0);

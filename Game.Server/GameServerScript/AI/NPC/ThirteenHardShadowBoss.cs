...
namespace GameServerScript.AI.NPC
{
	public class ThirteenHardShadowBoss : ABrain
	{
		...
		{
			int num = base.Game.Random.Next(0, ThirteenHardShadowBoss.AngryChat.Length);
			base.Body.Say(ThirteenHardShadowBoss.AngryChat[num], 1, 0);
		...
		{
			base.Body.CurrentDamagePlus = 10f;
			int num = base.Game.Random.Next(0, ThirteenHardShadowBoss.KillAttackChat.Length);
			((SimpleBoss)base.Body).Say(ThirteenHardShadowBoss.KillAttackChat[num], 1, 500);

...
namespace GameServerScript.AI.NPC
{
	public class DCSM40008Boss : ABrain
	{
		...
		public void HalfAttack()
		{
			...
			int num = base.Game.Random.Next(0, DCSM40008Boss.SealChat.Length);
			base.Body.Say(DCSM40008Boss.AllAttackChat[num], 1, 500);
		...
		public void Summon()
		{
			int num = base.Game.Random.Next(0, DCSM40008Boss.CallChat.Length);
			base.Body.Say(DCSM40008Boss.CallChat[num], 1, 0);
		...
		{
			int num = base.Game.Random.Next(0, DCSM40008Boss.SealChat.Length);
			((SimpleBoss)base.Body).Say(DCSM40008Boss.SealChat[num], 1, 0);
		...
		public void KillAttack(int fx, int tx)
		{
			...
			int num = base.Game.Random.Next(0, DCSM40008Boss.KillAttackChat.Length);
			((SimpleBoss)base.Body).Say(DCSM40008Boss.KillAttackChat[num], 1, 500);
			base.Body.PlayMovie("beatB", 2500, 0);

...
namespace GameServerScript.AI.NPC
{
    public class ThirteenHardBrotherNpc : ABrain
    {
        ...
        public void JumpPersonalAttack()
        {
            ...
            base.Body.JumpTo(base.Body.X, base.Body.Y - 150, "", 0, 1, 5, new LivingCallBack(this.PersonalAttack));
        ...
        public void Jump()
        {
            ...
            base.Body.JumpTo(base.Body.X, base.Body.Y - 150, "", 1000, 1,5, new LivingCallBack(this.CreateChild));
            ((SimpleBoss)base.Body).SetRelateDemagemRect(-41, -107, 83, 100);
        }
        ...
        public void KillAttack(int fx, int tx)
        {
            ...
            int num = base.Game.Random.Next(0, ThirteenHardBrotherNpc.KillAttackChat.Length);
            ((SimpleBoss)base.Body).Say(ThirteenHardBrotherNpc.KillAttackChat[num], 1, 500);

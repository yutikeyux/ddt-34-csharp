...
namespace GameServerScript.AI.NPC
{
	public class ThirdTerrorKingThird : ABrain
	{
		...
		public void HalfAttack()
		{
			...
			int num = base.Game.Random.Next(0, ThirdTerrorKingThird.SealChat.Length);
			base.Body.Say(ThirdTerrorKingThird.AllAttackChat[num], 1, 500);
		...
		public void Summon()
		{
			int num = base.Game.Random.Next(0, ThirdTerrorKingThird.CallChat.Length);
			base.Body.Say(ThirdTerrorKingThird.CallChat[num], 1, 0);
		...
		public void KillAttack(int fx, int mx)
		{
			...
			int num = base.Game.Random.Next(0, ThirdTerrorKingThird.KillAttackChat.Length);
			((SimpleBoss)base.Body).Say(ThirdTerrorKingThird.KillAttackChat[num], 1, 500);
			base.Body.PlayMovie("beatC", 2500, 0);

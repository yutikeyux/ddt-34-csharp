...
namespace GameServerScript.AI.NPC
{
	public class SimpleKingFirst : ABrain
	{
		...
		private void KillAttack(int fx, int tx)
		{
			...
			int num = base.Game.Random.Next(0, SimpleKingFirst.KillAttackChat.Length);
			base.Body.Say(SimpleKingFirst.KillAttackChat[num], 1, 1000);
		...
		private void AllAttack()
		{
			...
			int num = base.Game.Random.Next(0, SimpleKingFirst.AllAttackChat.Length);
			base.Body.Say(SimpleKingFirst.AllAttackChat[num], 1, 0);
		...
		{
			int num = base.Game.Random.Next(0, SimpleKingFirst.AddBooldChat.Length);
			base.Body.Say(SimpleKingFirst.AddBooldChat[num], 1, 0);
		...
		private void NextAttack()
		{
			...
			int num = base.Game.Random.Next(0, SimpleKingFirst.ShootChat.Length);
			base.Body.Say(SimpleKingFirst.ShootChat[num], 1, 0);
			if (player != null)
			{

...
namespace GameServerScript.AI.NPC
{
	public class ThirdTerrorShortNpcSecond : ABrain
	{
		...
		public override void OnBeginNewTurn()
		{
			...
			{
				string oneChat = ThirdTerrorShortNpcSecond.GetOneChat();
		...
		{
			int num = ThirdTerrorShortNpcSecond.random.Next(0, ThirdTerrorShortNpcSecond.listChat.Length);
			return ThirdTerrorShortNpcSecond.listChat[num];
		}
		...
		public static void LivingSay(List<Living> livings)
		{
			if (livings != null && livings.Count != 0)
			{
				...
				if (count <= 5)
				{
					num = ThirdTerrorShortNpcSecond.random.Next(0, 2);
				}
				else if (count > 5 && count <= 10)
				{
					num = ThirdTerrorShortNpcSecond.random.Next(1, 3);
				}
				else
				{
					num = ThirdTerrorShortNpcSecond.random.Next(1, 4);
				}
				if (num > 0)
				{

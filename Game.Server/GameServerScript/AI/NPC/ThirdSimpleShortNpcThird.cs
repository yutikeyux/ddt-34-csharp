...
namespace GameServerScript.AI.NPC
{
	public class ThirdSimpleShortNpcThird : ABrain
	{
		...
		public override void OnBeginNewTurn()
		{
			...
			{
				string oneChat = ThirdSimpleShortNpcThird.GetOneChat();
		...
		{
			int num = ThirdSimpleShortNpcThird.random.Next(0, ThirdSimpleShortNpcThird.listChat.Length);
			return ThirdSimpleShortNpcThird.listChat[num];
		}
		...
		public static void LivingSay(List<Living> livings)
		{
			if (livings != null && livings.Count != 0)
			{
				...
				if (count <= 5)
				{
					num = ThirdSimpleShortNpcThird.random.Next(0, 2);
				}
				else if (count > 5 && count <= 10)
				{
					num = ThirdSimpleShortNpcThird.random.Next(1, 3);
				}
				else
				{
					num = ThirdSimpleShortNpcThird.random.Next(1, 4);
				}
				if (num > 0)
				{

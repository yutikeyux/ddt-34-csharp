...
namespace GameServerScript.AI.NPC
{
	public class ZYSimpleNpc60010 : ABrain
	{
		...
		public void HalfAttack()
		{
			...
			int num = base.Game.Random.Next(0, ZYSimpleNpc60010.SealChat.Length);
			base.Body.Say(ZYSimpleNpc60010.AllAttackChat[num], 1, 500);
		...
		public void Summon()
		{
			int num = base.Game.Random.Next(0, ZYSimpleNpc60010.CallChat.Length);
			base.Body.Say(ZYSimpleNpc60010.CallChat[num], 1, 0);
		...
		{
			int num = base.Game.Random.Next(0, ZYSimpleNpc60010.SealChat.Length);
			((SimpleBoss)base.Body).Say(ZYSimpleNpc60010.SealChat[num], 1, 0);
		...
		public void KillAttack(int fx, int tx)
		{
			...
			int num = base.Game.Random.Next(0, ZYSimpleNpc60010.KillAttackChat.Length);
			((SimpleBoss)base.Body).Say(ZYSimpleNpc60010.KillAttackChat[num], 1, 500);
			base.Body.PlayMovie("beatB", 2500, 0);

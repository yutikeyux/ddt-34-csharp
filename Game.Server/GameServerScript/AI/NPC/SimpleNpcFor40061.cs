...
namespace GameServerScript.AI.NPC
{
	public class SimpleNpcFor40061 : ABrain
	{
		...
		public override void OnBeginNewTurn()
		{
			...
			{
				string oneChat = SimpleNpcFor40061.GetOneChat();
		...
		{
			int num = SimpleNpcFor40061.random.Next(0, SimpleNpcFor40061.listChat.Length);
			return SimpleNpcFor40061.listChat[num];
		}
		...
		public static void LivingSay(List<Living> livings)
		{
			if (livings != null && livings.Count != 0)
			{
				...
				if (count <= 5)
				{
					num = SimpleNpcFor40061.random.Next(0, 2);
				}
				else if (count > 5 && count <= 10)
				{
					num = SimpleNpcFor40061.random.Next(1, 3);
				}
				else
				{
					num = SimpleNpcFor40061.random.Next(1, 4);
				}
				if (num > 0)
				{

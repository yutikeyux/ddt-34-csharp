...
namespace GameServerScript.AI.NPC
{
	public class FourHardHawkNpc : ABrain
	{
		...
		private void WalkA()
		{
			...
			base.Body.MoveTo(x, base.Body.Y, "fly", 3000, "", 12, new LivingCallBack(this.AllAttack));
		}
		...
		{
			base.Body.Direction = base.Game.FindlivingbyDir(base.Body);
			int num = base.Game.Random.Next(0, FourHardHawkNpc.AllAttackChat.Length);
			base.Body.Say(FourHardHawkNpc.AllAttackChat[num], 1, 1000);

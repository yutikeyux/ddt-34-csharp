...
namespace GameServerScript.AI.NPC
{
	public class ThirteenHardAntBoss : ABrain
	{
		...
		{
			int num = base.Game.Random.Next(0, ThirteenHardAntBoss.KillAttackChat.Length);
			base.Body.Say(ThirteenHardAntBoss.KillAttackChat[num], 1, 1000);
		...
		private void PersonalAttack()
		{
			...
			if (player != null)
			{
				...
				int num = base.Game.Random.Next(0, ThirteenHardAntBoss.KillPlayerChat.Length);
				base.Body.Say(ThirteenHardAntBoss.KillPlayerChat[num], 1, 0);
		...
		private void Plain()
		{
			int num = base.Game.Random.Next(0, ThirteenHardAntBoss.ShootChat.Length);
			base.Body.Say(ThirteenHardAntBoss.ShootChat[num], 1, 0);
		...
		public override void OnKillPlayerSay()
		{
			...
			int num = base.Game.Random.Next(0, ThirteenHardAntBoss.KillPlayerChat.Length);
			base.Body.Say(ThirteenHardAntBoss.KillPlayerChat[num], 1, 0, 2000);
		}
		...
		{
			int num = base.Game.Random.Next(0, ThirteenHardAntBoss.ShootedChat.Length);
			if (this.isSay == 0 && base.Body.IsLiving)
			{
				base.Body.Say(ThirteenHardAntBoss.ShootedChat[num], 1, 900, 0);
				this.isSay = 1;
			}
			if (!base.Body.IsLiving)
			{
				num = base.Game.Random.Next(0, ThirteenHardAntBoss.DiedChat.Length);
				base.Body.Say(ThirteenHardAntBoss.DiedChat[num], 1, 100, 2000);
			}
		}
	}
}

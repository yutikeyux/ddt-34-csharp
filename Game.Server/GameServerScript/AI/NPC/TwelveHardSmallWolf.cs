			...
			if (num > 97)
			{
				...
				if (player.Y < 420 && player.X < 210)
				{
					if (base.Body.Y > 420)
					{
						...
						{
							base.Body.MoveTo(25, base.Body.Y, "walk", 1200, "", 3, new LivingCallBack(this.MoveBeat));
						}
						else
						{
				...
				else if (base.Body.Y < 420)
				{
					...
					{
						base.Body.MoveTo(200, base.Body.Y, "walk", 1200, "", 3, new LivingCallBack(this.MoveBeat));
					}
				}
				else if (player.X > base.Body.X)
				{

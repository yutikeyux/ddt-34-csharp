...
namespace GameServerScript.AI.NPC
{
	public class ThirdHardShortNpcThird : ABrain
	{
		...
		public override void OnBeginNewTurn()
		{
			...
			{
				string oneChat = ThirdHardShortNpcThird.GetOneChat();
		...
		{
			int num = ThirdHardShortNpcThird.random.Next(0, ThirdHardShortNpcThird.listChat.Length);
			return ThirdHardShortNpcThird.listChat[num];
		}
		...
		public static void LivingSay(List<Living> livings)
		{
			if (livings != null && livings.Count != 0)
			{
				...
				if (count <= 5)
				{
					num = ThirdHardShortNpcThird.random.Next(0, 2);
				}
				else if (count > 5 && count <= 10)
				{
					num = ThirdHardShortNpcThird.random.Next(1, 3);
				}
				else
				{
					num = ThirdHardShortNpcThird.random.Next(1, 4);
				}
				if (num > 0)
				{

...
namespace GameServerScript.AI.NPC
{
	public class SimpleCaptainAi : ABrain
	{
		...
		private void AllAttack()
		{
			...
			int num = base.Game.Random.Next(0, SimpleCaptainAi.AllAttackChat.Length);
			base.Body.Say(SimpleCaptainAi.AllAttackChat[num], 1, 0);
		...
		{
			this.ChangeDirection(3);
			int num = base.Game.Random.Next(0, SimpleCaptainAi.ShootChat.Length);
			base.Body.Say(SimpleCaptainAi.ShootChat[num], 1, 0);
		...
		private void Summon()
		{
			...
			int num = base.Game.Random.Next(0, SimpleCaptainAi.CallChat.Length);
			base.Body.Say(SimpleCaptainAi.CallChat[num], 1, 3300);

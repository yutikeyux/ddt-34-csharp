...
namespace GameServerScript.AI.NPC
{
	public class ThirdTerrorShortNpcThird : ABrain
	{
		...
		public override void OnBeginNewTurn()
		{
			...
			{
				string oneChat = ThirdTerrorShortNpcThird.GetOneChat();
		...
		{
			int num = ThirdTerrorShortNpcThird.random.Next(0, ThirdTerrorShortNpcThird.listChat.Length);
			return ThirdTerrorShortNpcThird.listChat[num];
		}
		...
		public static void LivingSay(List<Living> livings)
		{
			if (livings != null && livings.Count != 0)
			{
				...
				if (count <= 5)
				{
					num = ThirdTerrorShortNpcThird.random.Next(0, 2);
				}
				else if (count > 5 && count <= 10)
				{
					num = ThirdTerrorShortNpcThird.random.Next(1, 3);
				}
				else
				{
					num = ThirdTerrorShortNpcThird.random.Next(1, 4);
				}
				if (num > 0)
				{

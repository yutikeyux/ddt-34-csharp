...
{
	public class TayVuongMau : ABrain
	{
        ...
        private static string[] ShootChat = new string[]{
            "Quan tài của Cưng , chị làm xong rồi đó",
        };

        private static string[] KillPlayerChat = new string[]{
            "Alo chú Công An hã~~~ Ở đây có người thả thính！"
        };
		...
		private void KillA()
		{
			...
			base.Body.CurrentDamagePlus = 300f;
		...
		{ 
			...
			Player player = base.Game.FindRandomPlayer();
			base.Body.CurrentDamagePlus = 310f;	
		...
		public void Attack()
		{
			...
			Player player = base.Game.FindRandomPlayer();
			base.Body.CurrentDamagePlus = 320f;
		...
		private void KillC()
		{
			...
			Player player = base.Game.FindRandomPlayer();
			base.Body.CurrentDamagePlus = 330f;
			base.Body.PlayMovie("beatC", 2400, 0);
			base.Body.RangeAttacking(base.Body.X - 1000, base.Body.X + 1000, "cry", 4000, null);
		}
		...
		{           
			...
			base.Body.CurrentDamagePlus = 10000000f;

...
namespace GameServerScript.AI.NPC
{
	public class SimpleKingLast : ABrain
	{
		...
		public void HalfAttack()
		{
			...
			int num = base.Game.Random.Next(0, SimpleKingLast.SealChat.Length);
			base.Body.Say(SimpleKingLast.AllAttackChat[num], 1, 500);
		...
		public void Summon()
		{
			int num = base.Game.Random.Next(0, SimpleKingLast.CallChat.Length);
			base.Body.Say(SimpleKingLast.CallChat[num], 1, 0);
		...
		{
			int num = base.Game.Random.Next(0, SimpleKingLast.SealChat.Length);
			((SimpleBoss)base.Body).Say(SimpleKingLast.SealChat[num], 1, 0);
		...
		public void Angger()
		{
			int num = base.Game.Random.Next(0, SimpleKingLast.AngryChat.Length);
			base.Body.Say(SimpleKingLast.AngryChat[num], 1, 0);
			base.Body.State = 1;
			this.Dander += 100;
		...
		public void KillAttack(int fx, int mx)
		{
			...
			int num = base.Game.Random.Next(0, SimpleKingLast.KillAttackChat.Length);
			((SimpleBoss)base.Body).Say(SimpleKingLast.KillAttackChat[num], 1, 500);
			base.Body.PlayMovie("beatB", 2500, 0);

...
namespace GameServerScript.AI.NPC
{
	public class ThirdNormalKingFirst : ABrain
	{
		...
		private void KillAttack(int fx, int tx)
		{
			...
			int num = base.Game.Random.Next(0, ThirdNormalKingFirst.KillAttackChat.Length);
			base.Body.Say(ThirdNormalKingFirst.KillAttackChat[num], 0, 1000);
		...
		{
			int num = base.Game.Random.Next(0, ThirdNormalKingFirst.CallChat.Length);
			base.Body.Say(ThirdNormalKingFirst.CallChat[num], 0, 3300);
		...
		private void NextAttack()
		{
			...
			int num = base.Game.Random.Next(0, ThirdNormalKingFirst.ShootChat.Length);
			base.Body.Say(ThirdNormalKingFirst.ShootChat[num], 0, 0);
			if (player != null)
			{

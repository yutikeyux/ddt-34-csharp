...
namespace GameServerScript.AI.NPC
{
	public class NormalKingZhen : ABrain
	{
		...
		public void HalfAttack()
		{
			...
			int num = base.Game.Random.Next(0, NormalKingZhen.SealChat.Length);
			base.Body.Say(NormalKingZhen.AllAttackChat[num], 1, 500);
		...
		public void Summon()
		{
			int num = base.Game.Random.Next(0, NormalKingZhen.CallChat.Length);
			base.Body.Say(NormalKingZhen.CallChat[num], 1, 0);
		...
		{
			int num = base.Game.Random.Next(0, NormalKingZhen.SealChat.Length);
			((SimpleBoss)base.Body).Say(NormalKingZhen.SealChat[num], 1, 0);
		...
		public void Angger()
		{
			int num = base.Game.Random.Next(0, NormalKingZhen.AngryChat.Length);
			base.Body.Say(NormalKingZhen.AngryChat[num], 1, 0);
			base.Body.State = 1;
			this.Dander += 100;
		...
		public void KillAttack(int fx, int tx)
		{
			...
			int num = base.Game.Random.Next(0, NormalKingZhen.KillAttackChat.Length);
			((SimpleBoss)base.Body).Say(NormalKingZhen.KillAttackChat[num], 1, 500);
			base.Body.PlayMovie("beatB", 2500, 0);

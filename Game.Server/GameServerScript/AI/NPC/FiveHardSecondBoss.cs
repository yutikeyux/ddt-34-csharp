...
namespace GameServerScript.AI.NPC
{
	public class FiveHardSecondBoss : ABrain
	{
		...
		{
			int num = base.Game.Random.Next(0, FiveHardSecondBoss.KillAttackChat.Length);
			if (this.m_turn == 0)
			{
				base.Body.CurrentDamagePlus = 10f;
				base.Body.Say(FiveHardSecondBoss.KillAttackChat[num], 1, 13000);
			...
			{
				base.Body.CurrentDamagePlus = 10f;
				base.Body.Say(FiveHardSecondBoss.KillAttackChat[num], 1, 0);
		...
		{
			int num = base.Game.Random.Next(0, FiveHardSecondBoss.AllAttackChat.Length);
			base.Body.Say(FiveHardSecondBoss.AllAttackChat[num], 1, 0);

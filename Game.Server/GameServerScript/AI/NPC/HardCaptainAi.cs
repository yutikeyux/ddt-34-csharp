...
namespace GameServerScript.AI.NPC
{
	public class HardCaptainAi : ABrain
	{
		...
		private void KillAttack(int fx, int tx)
		{
			...
			int num = base.Game.Random.Next(0, HardCaptainAi.KillAttackChat.Length);
			base.Body.Say(HardCaptainAi.KillAttackChat[num], 1, 1000);
		...
		private void AllAttack()
		{
			...
			int num = base.Game.Random.Next(0, HardCaptainAi.AllAttackChat.Length);
			base.Body.Say(HardCaptainAi.AllAttackChat[num], 1, 0);
		...
		{
			this.ChangeDirection(3);
			int num = base.Game.Random.Next(0, HardCaptainAi.ShootChat.Length);
			base.Body.Say(HardCaptainAi.ShootChat[num], 1, 0);
		...
		private void Summon()
		{
			...
			int num = base.Game.Random.Next(0, HardCaptainAi.CallChat.Length);
			base.Body.Say(HardCaptainAi.CallChat[num], 1, 3300);

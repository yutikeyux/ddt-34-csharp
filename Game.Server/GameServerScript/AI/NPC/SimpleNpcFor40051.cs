...
namespace GameServerScript.AI.NPC
{
	public class SimpleNpcFor40051 : ABrain
	{
		...
		public override void OnBeginNewTurn()
		{
			...
			{
				string oneChat = SimpleNpcFor40051.GetOneChat();
		...
		{
			int num = SimpleNpcFor40051.random.Next(0, SimpleNpcFor40051.listChat.Length);
			return SimpleNpcFor40051.listChat[num];
		}
		...
		public static void LivingSay(List<Living> livings)
		{
			if (livings != null && livings.Count != 0)
			{
				...
				if (count <= 5)
				{
					num = SimpleNpcFor40051.random.Next(0, 2);
				}
				else if (count > 5 && count <= 10)
				{
					num = SimpleNpcFor40051.random.Next(1, 3);
				}
				else
				{
					num = SimpleNpcFor40051.random.Next(1, 4);
				}
				if (num > 0)
				{

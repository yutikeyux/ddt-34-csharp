...
namespace GameServerScript.AI.NPC
{
	public class SimpleKingZhen : ABrain
	{
		...
		public void HalfAttack()
		{
			...
			int num = base.Game.Random.Next(0, SimpleKingZhen.SealChat.Length);
			base.Body.Say(SimpleKingZhen.AllAttackChat[num], 1, 500);
		...
		public void Summon()
		{
			int num = base.Game.Random.Next(0, SimpleKingZhen.CallChat.Length);
			base.Body.Say(SimpleKingZhen.CallChat[num], 1, 0);
		...
		{
			int num = base.Game.Random.Next(0, SimpleKingZhen.SealChat.Length);
			((SimpleBoss)base.Body).Say(SimpleKingZhen.SealChat[num], 1, 0);
		...
		public void Angger()
		{
			int num = base.Game.Random.Next(0, SimpleKingZhen.AngryChat.Length);
			base.Body.Say(SimpleKingZhen.AngryChat[num], 1, 0);
			base.Body.State = 1;
			this.Dander += 100;
		...
		public void KillAttack(int fx, int tx)
		{
			...
			int num = base.Game.Random.Next(0, SimpleKingZhen.KillAttackChat.Length);
			((SimpleBoss)base.Body).Say(SimpleKingZhen.KillAttackChat[num], 1, 500);
			base.Body.PlayMovie("beatB", 2500, 0);

...
namespace GameServerScript.AI.NPC
{
	public class ThirdNormalKingThird : ABrain
	{
		...
		public void HalfAttack()
		{
			...
			int num = base.Game.Random.Next(0, ThirdNormalKingThird.SealChat.Length);
			base.Body.Say(ThirdNormalKingThird.AllAttackChat[num], 1, 500);
		...
		public void Summon()
		{
			int num = base.Game.Random.Next(0, ThirdNormalKingThird.CallChat.Length);
			base.Body.Say(ThirdNormalKingThird.CallChat[num], 1, 0);
		...
		public void KillAttack(int fx, int mx)
		{
			...
			int num = base.Game.Random.Next(0, ThirdNormalKingThird.KillAttackChat.Length);
			((SimpleBoss)base.Body).Say(ThirdNormalKingThird.KillAttackChat[num], 1, 500);
			base.Body.PlayMovie("beatC", 2500, 0);

...
namespace GameServerScript.AI.NPC
{
	public class ThirteenSimpleDevilBoss : ABrain
	{
		...
		private void CallHopquaidi()
		{
			...
			int num = base.Game.Random.Next(0, ThirteenSimpleDevilBoss.ShootChat.Length);
			base.Body.Say(ThirteenSimpleDevilBoss.ShootChat[num], 1, 0);
		...
		{
			int num = base.Game.Random.Next(0, ThirteenSimpleDevilBoss.AddBooldChat.Length);
			base.Body.Say(ThirteenSimpleDevilBoss.AddBooldChat[num], 1, 0);
			base.Body.Direction = base.Game.FindlivingbyDir(base.Body);
		...
		private void KillAttack(int fx, int tx)
		{
			...
			int num = base.Game.Random.Next(0, ThirteenSimpleDevilBoss.KillAttackChat.Length);
			base.Body.Say(ThirteenSimpleDevilBoss.KillAttackChat[num], 1, 1000);

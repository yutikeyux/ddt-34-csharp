...
namespace GameServerScript.AI.NPC
{
	public class ThirteenSimpleBrynBoss : ABrain
	{
		...
		{
			int num = base.Game.Random.Next(0, ThirteenSimpleBrynBoss.KillAttackChat.Length);
			base.Body.Say(ThirteenSimpleBrynBoss.KillAttackChat[num], 1, 1000);
		...
		{
			int num = base.Game.Random.Next(0, ThirteenSimpleBrynBoss.ShootChat.Length);
			base.Body.Say(ThirteenSimpleBrynBoss.ShootChat[num], 1, 0);
		...
		public override void OnKillPlayerSay()
		{
			...
			int num = base.Game.Random.Next(0, ThirteenSimpleBrynBoss.KillPlayerChat.Length);
			base.Body.Say(ThirteenSimpleBrynBoss.KillPlayerChat[num], 1, 0, 2000);
		}

		public override void OnShootedSay()
		{
			int num = base.Game.Random.Next(0, ThirteenSimpleBrynBoss.ShootedChat.Length);
			if (this.isSay == 0 && base.Body.IsLiving)
			{
				base.Body.Say(ThirteenSimpleBrynBoss.ShootedChat[num], 1, 900, 0);
				this.isSay = 1;
			}
			if (!base.Body.IsLiving)
			{
				num = base.Game.Random.Next(0, ThirteenSimpleBrynBoss.DiedChat.Length);
				base.Body.Say(ThirteenSimpleBrynBoss.DiedChat[num], 1, 100, 2000);
			}
		}
	}
}

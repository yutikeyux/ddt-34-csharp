...
namespace GameServerScript.AI.NPC
{
	public class ThirteenSimpleNioBoss : ABrain
	{
		...
		private void KillAttack(int fx, int tx)
		{
			...
			int num = base.Game.Random.Next(0, ThirteenSimpleNioBoss.KillAttackChat.Length);
			base.Body.Say(ThirteenSimpleNioBoss.KillAttackChat[num], 1, 1000);
		...
		private void AllAttack()
		{
			...
			int num = base.Game.Random.Next(0, ThirteenSimpleNioBoss.AllAttackChat.Length);
			base.Body.Say(ThirteenSimpleNioBoss.AllAttackChat[num], 1, 0);
		...
		{
			int num = base.Game.Random.Next(0, ThirteenSimpleNioBoss.AddBooldChat.Length);
			base.Body.Say(ThirteenSimpleNioBoss.AddBooldChat[num], 1, 0);
		...
		private void NextAttack()
		{
			...
			int num = base.Game.Random.Next(0, ThirteenSimpleNioBoss.ShootChat.Length);
			base.Body.Say(ThirteenSimpleNioBoss.ShootChat[num], 1, 0);
			if (player != null)
			{

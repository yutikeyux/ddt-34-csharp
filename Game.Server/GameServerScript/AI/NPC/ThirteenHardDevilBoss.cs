...
namespace GameServerScript.AI.NPC
{
	public class ThirteenHardDevilBoss : ABrain
	{
		...
		private void CallHopquaidi()
		{
			...
			int num = base.Game.Random.Next(0, ThirteenHardDevilBoss.ShootChat.Length);
			base.Body.Say(ThirteenHardDevilBoss.ShootChat[num], 1, 0);
		...
		{
			int num = base.Game.Random.Next(0, ThirteenHardDevilBoss.AddBooldChat.Length);
			base.Body.Say(ThirteenHardDevilBoss.AddBooldChat[num], 1, 0);
			base.Body.Direction = base.Game.FindlivingbyDir(base.Body);
		...
		private void KillAttack(int fx, int tx)
		{
			...
			int num = base.Game.Random.Next(0, ThirteenHardDevilBoss.KillAttackChat.Length);
			base.Body.Say(ThirteenHardDevilBoss.KillAttackChat[num], 1, 1000);

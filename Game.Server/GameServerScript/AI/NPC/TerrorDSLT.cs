...
{
    public class TerrorDSLT : ABrain
    {
        private int m_attackTurn = 0;

        private int npcID = 71125;
        ...
        {
            int num = base.Game.Random.Next(0, TerrorDSLT.KillAttackChat.Length);
            base.Body.Say(TerrorDSLT.KillAttackChat[num], 1, 1000);
        ...
        private void PersonalAttack()
        {
            ...
            {
                base.Body.CurrentDamagePlus = 1f;
                int num = base.Game.Random.Next(0, TerrorDSLT.ShootChat.Length);
                base.Body.Say(TerrorDSLT.ShootChat[num], 1, 0);
        ...
        private void Summon()
        {
            int num = base.Game.Random.Next(0, TerrorDSLT.CallChat.Length);
            base.Body.Say(TerrorDSLT.CallChat[num], 1, 600);
        ...
        private void Call()
        {
            ((SimpleBoss)base.Body).CreateChild(this.npcID, this.brithPoint, 9, 3, 1);
        }

        public override void OnKillPlayerSay()
        {
            base.OnKillPlayerSay();
            int num = base.Game.Random.Next(0, TerrorDSLT.KillPlayerChat.Length);
            base.Body.Say(TerrorDSLT.KillPlayerChat[num], 1, 0, 2000);
        }
        ...
        {
            int num = base.Game.Random.Next(0, TerrorDSLT.ShootedChat.Length);
            if (this.isSay == 0 && base.Body.IsLiving)
            {
                base.Body.Say(TerrorDSLT.ShootedChat[num], 1, 900, 0);
                this.isSay = 1;
            }
            if (!base.Body.IsLiving)
            {
                num = base.Game.Random.Next(0, TerrorDSLT.DiedChat.Length);
                base.Body.Say(TerrorDSLT.DiedChat[num], 1, 100, 2000);
            }
        }
    }
}

...
{
    public class SimpleDSLT : ABrain
    {
        private int m_attackTurn = 0;

        private int npcID = 71122;
        ...
        {
            int num = base.Game.Random.Next(0, SimpleDSLT.KillAttackChat.Length);
            base.Body.Say(SimpleDSLT.KillAttackChat[num], 1, 1000);
        ...
        private void PersonalAttack()
        {
            ...
            {
                base.Body.CurrentDamagePlus = 1f;
                int num = base.Game.Random.Next(0, SimpleDSLT.ShootChat.Length);
                base.Body.Say(SimpleDSLT.ShootChat[num], 1, 0);
        ...
        private void Summon()
        {
            int num = base.Game.Random.Next(0, SimpleDSLT.CallChat.Length);
            base.Body.Say(SimpleDSLT.CallChat[num], 1, 600);
        ...
        public override void OnKillPlayerSay()
        {
            ...
            int num = base.Game.Random.Next(0, SimpleDSLT.KillPlayerChat.Length);
            base.Body.Say(SimpleDSLT.KillPlayerChat[num], 1, 0, 2000);
        }
        ...
        {
            int num = base.Game.Random.Next(0, SimpleDSLT.ShootedChat.Length);
            if (this.isSay == 0 && base.Body.IsLiving)
            {
                base.Body.Say(SimpleDSLT.ShootedChat[num], 1, 900, 0);
                this.isSay = 1;
            }
            if (!base.Body.IsLiving)
            {
                num = base.Game.Random.Next(0, SimpleDSLT.DiedChat.Length);
                base.Body.Say(SimpleDSLT.DiedChat[num], 1, 100, 2000);
            }
        }
    }
}

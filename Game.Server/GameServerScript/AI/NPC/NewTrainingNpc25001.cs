...
namespace GameServerScript.AI.NPC
{
	public class NewTrainingNpc25001 : ABrain
	{
		...
		public override void OnBeginNewTurn()
		{
			...
			{
				string oneChat = NewTrainingNpc25001.GetOneChat();
		...
		{
			int num = NewTrainingNpc25001.random.Next(0, NewTrainingNpc25001.listChat.Length);
			return NewTrainingNpc25001.listChat[num];
		}
		...
		public static void LivingSay(List<Living> livings)
		{
			if (livings != null && livings.Count != 0)
			{
				...
				if (count <= 5)
				{
					num = NewTrainingNpc25001.random.Next(0, 2);
				}
				else if (count > 5 && count <= 10)
				{
					num = NewTrainingNpc25001.random.Next(1, 3);
				}
				else
				{
					num = NewTrainingNpc25001.random.Next(1, 4);
				}
				if (num > 0)
				{

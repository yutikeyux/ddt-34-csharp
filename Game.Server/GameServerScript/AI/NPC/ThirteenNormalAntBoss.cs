...
namespace GameServerScript.AI.NPC
{
	public class ThirteenNormalAntBoss : ABrain
	{
		...
		{
			int num = base.Game.Random.Next(0, ThirteenNormalAntBoss.KillAttackChat.Length);
			base.Body.Say(ThirteenNormalAntBoss.KillAttackChat[num], 1, 1000);
		...
		private void PersonalAttack()
		{
			...
			if (player != null)
			{
				...
				int num = base.Game.Random.Next(0, ThirteenNormalAntBoss.KillPlayerChat.Length);
				base.Body.Say(ThirteenNormalAntBoss.KillPlayerChat[num], 1, 0);
		...
		private void Plain()
		{
			int num = base.Game.Random.Next(0, ThirteenNormalAntBoss.ShootChat.Length);
			base.Body.Say(ThirteenNormalAntBoss.ShootChat[num], 1, 0);
		...
		public override void OnKillPlayerSay()
		{
			...
			int num = base.Game.Random.Next(0, ThirteenNormalAntBoss.KillPlayerChat.Length);
			base.Body.Say(ThirteenNormalAntBoss.KillPlayerChat[num], 1, 0, 2000);
		}
		...
		{
			int num = base.Game.Random.Next(0, ThirteenNormalAntBoss.ShootedChat.Length);
			if (this.isSay == 0 && base.Body.IsLiving)
			{
				base.Body.Say(ThirteenNormalAntBoss.ShootedChat[num], 1, 900, 0);
				this.isSay = 1;
			}
			if (!base.Body.IsLiving)
			{
				num = base.Game.Random.Next(0, ThirteenNormalAntBoss.DiedChat.Length);
				base.Body.Say(ThirteenNormalAntBoss.DiedChat[num], 1, 100, 2000);
			}
		}
	}
}

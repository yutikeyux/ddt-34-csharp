...
namespace GameServerScript.AI.NPC
{
	public class ThirdTerrorKingSecond : ABrain
	{
		...
		private void KillAttack(int fx, int tx)
		{
			...
			int num = base.Game.Random.Next(0, ThirdTerrorKingSecond.KillAttackChat.Length);
			base.Body.Say(ThirdTerrorKingSecond.KillAttackChat[num], 1, 1000);
		...
		private void Summon()
		{
			int num = base.Game.Random.Next(0, ThirdTerrorKingSecond.CallChat.Length);
			base.Body.Say(ThirdTerrorKingSecond.CallChat[num], 0, 3300);
		...
		private void NextAttack()
		{
			...
			int num = base.Game.Random.Next(0, ThirdTerrorKingSecond.ShootChat.Length);
			base.Body.Say(ThirdTerrorKingSecond.ShootChat[num], 0, 0);
			if (player != null)
			{

...
namespace GameServerScript.AI.NPC
{
	public class FiveTerrorSecondBoss : ABrain
	{
		...
		{
			int num = base.Game.Random.Next(0, FiveTerrorSecondBoss.KillAttackChat.Length);
			if (this.m_turn == 0)
			{
				base.Body.CurrentDamagePlus = 10f;
				base.Body.Say(FiveTerrorSecondBoss.KillAttackChat[num], 1, 13000);
			...
			{
				base.Body.CurrentDamagePlus = 10f;
				base.Body.Say(FiveTerrorSecondBoss.KillAttackChat[num], 1, 0);
		...
		{
			int num = base.Game.Random.Next(0, FiveTerrorSecondBoss.AllAttackChat.Length);
			base.Body.Say(FiveTerrorSecondBoss.AllAttackChat[num], 1, 0);

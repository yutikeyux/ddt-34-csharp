...
namespace GameServerScript.AI.NPC
{
	public class TerrorKingZhen : ABrain
	{
		...
		public void HalfAttack()
		{
			...
			int num = base.Game.Random.Next(0, TerrorKingZhen.SealChat.Length);
			base.Body.Say(TerrorKingZhen.AllAttackChat[num], 1, 500);
		...
		public void Summon()
		{
			int num = base.Game.Random.Next(0, TerrorKingZhen.CallChat.Length);
			base.Body.Say(TerrorKingZhen.CallChat[num], 1, 0);
		...
		{
			int num = base.Game.Random.Next(0, TerrorKingZhen.SealChat.Length);
			((SimpleBoss)base.Body).Say(TerrorKingZhen.SealChat[num], 1, 0);
		...
		public void Angger()
		{
			int num = base.Game.Random.Next(0, TerrorKingZhen.AngryChat.Length);
			base.Body.Say(TerrorKingZhen.AngryChat[num], 1, 0);
			base.Body.State = 1;
			this.Dander += 100;
		...
		public void KillAttack(int fx, int tx)
		{
			...
			int num = base.Game.Random.Next(0, TerrorKingZhen.KillAttackChat.Length);
			((SimpleBoss)base.Body).Say(TerrorKingZhen.KillAttackChat[num], 1, 500);
			base.Body.PlayMovie("beatB", 2500, 0);

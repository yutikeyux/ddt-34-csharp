...
namespace GameServerScript.AI.NPC
{
	public class ThirteenTerrorDevilBoss : ABrain
	{
		...
		private void CallHopquaidi()
		{
			...
			int num = base.Game.Random.Next(0, ThirteenTerrorDevilBoss.ShootChat.Length);
			base.Body.Say(ThirteenTerrorDevilBoss.ShootChat[num], 1, 0);
		...
		{
			int num = base.Game.Random.Next(0, ThirteenTerrorDevilBoss.AddBooldChat.Length);
			base.Body.Say(ThirteenTerrorDevilBoss.AddBooldChat[num], 1, 0);
			base.Body.Direction = base.Game.FindlivingbyDir(base.Body);
		...
		private void KillAttack(int fx, int tx)
		{
			...
			int num = base.Game.Random.Next(0, ThirteenTerrorDevilBoss.KillAttackChat.Length);
			base.Body.Say(ThirteenTerrorDevilBoss.KillAttackChat[num], 1, 1000);

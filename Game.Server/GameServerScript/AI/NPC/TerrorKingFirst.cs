...
namespace GameServerScript.AI.NPC
{
	public class TerrorKingFirst : ABrain
	{
		...
		private void KillAttack(int fx, int tx)
		{
			...
			int num = base.Game.Random.Next(0, TerrorKingFirst.KillAttackChat.Length);
			base.Body.Say(TerrorKingFirst.KillAttackChat[num], 1, 1000);
		...
		private void AllAttack()
		{
			...
			int num = base.Game.Random.Next(0, TerrorKingFirst.AllAttackChat.Length);
			base.Body.Say(TerrorKingFirst.AllAttackChat[num], 1, 0);
		...
		{
			int num = base.Game.Random.Next(0, TerrorKingFirst.AddBooldChat.Length);
			base.Body.Say(TerrorKingFirst.AddBooldChat[num], 1, 0);
		...
		private void NextAttack()
		{
			...
			int num = base.Game.Random.Next(0, TerrorKingFirst.ShootChat.Length);
			base.Body.Say(TerrorKingFirst.ShootChat[num], 1, 0);
			if (player != null)
			{

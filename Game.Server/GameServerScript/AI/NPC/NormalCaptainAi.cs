...
namespace GameServerScript.AI.NPC
{
	public class NormalCaptainAi : ABrain
	{
		...
		private void KillAttack(int fx, int tx)
		{
			...
			int num = base.Game.Random.Next(0, NormalCaptainAi.KillAttackChat.Length);
			base.Body.Say(NormalCaptainAi.KillAttackChat[num], 1, 1000);
		...
		private void AllAttack()
		{
			...
			int num = base.Game.Random.Next(0, NormalCaptainAi.AllAttackChat.Length);
			base.Body.Say(NormalCaptainAi.AllAttackChat[num], 1, 0);
		...
		{
			this.ChangeDirection(3);
			int num = base.Game.Random.Next(0, NormalCaptainAi.ShootChat.Length);
			base.Body.Say(NormalCaptainAi.ShootChat[num], 1, 0);
		...
		private void Summon()
		{
			...
			int num = base.Game.Random.Next(0, NormalCaptainAi.CallChat.Length);
			base.Body.Say(NormalCaptainAi.CallChat[num], 1, 3300);

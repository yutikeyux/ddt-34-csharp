...
{
	public class SimpleBossFor790031 : ABrain
	{
		...
		public override void OnStartAttacking()
		{
			...
			else
			{
				...
				int num2 = base.Game.Random.Next(0, SimpleBossFor790031.AttackAChat.Length - 1);
				base.Body.Say(SimpleBossFor790031.AttackAChat[num2], 1, 500);

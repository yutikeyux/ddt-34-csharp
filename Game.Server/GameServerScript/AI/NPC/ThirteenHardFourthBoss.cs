...
namespace GameServerScript.AI.NPC
{
	public class ThirteenHardFourthBoss : ABrain
	{
		...
		{
			int num = base.Game.Random.Next(0, ThirteenHardFourthBoss.AngryChat.Length);
			base.Body.Say(ThirteenHardFourthBoss.AngryChat[num], 1, 0);
		...
		public void KillAttack(int fx, int tx)
		{
			...
			int num = base.Game.Random.Next(0, ThirteenHardFourthBoss.KillAttackChat.Length);
			((SimpleBoss)base.Body).Say(ThirteenHardFourthBoss.KillAttackChat[num], 1, 500);

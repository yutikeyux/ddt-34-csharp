...
namespace GameServerScript.AI.NPC
{
	public class ThirteenSimpleShadowBoss : ABrain
	{
		...
		{
			int num = base.Game.Random.Next(0, ThirteenSimpleShadowBoss.AngryChat.Length);
			base.Body.Say(ThirteenSimpleShadowBoss.AngryChat[num], 1, 0);
		...
		{
			base.Body.CurrentDamagePlus = 10f;
			int num = base.Game.Random.Next(0, ThirteenSimpleShadowBoss.KillAttackChat.Length);
			((SimpleBoss)base.Body).Say(ThirteenSimpleShadowBoss.KillAttackChat[num], 1, 500);

...
{
    public class FourNormalCattleBoss2 : ABrain
    {
        ...
        private static string[] ShootChat = new string[]{
             "Chuận bị đỡ đòn của ta đi",
                               
             "Các ngươi sẽ chềt",

             "Ta sẽ tiễn các ngươi xuống Âm phủ. Hahahaha!!!!!!!"
        };
        ...
        private void NextAttack()
        {
            ...
            if (target != null)
            {
                ...
                if (Body.ShootPoint(mtX, target.Y, 673, 1000, 10000, 1, 1, 2300))
                {
                    Body.PlayMovie("beat2", 1500, 0);
                }

                if (Body.ShootPoint(mtX, target.Y, 673, 1000, 10000, 1, 1, 4100))
                {

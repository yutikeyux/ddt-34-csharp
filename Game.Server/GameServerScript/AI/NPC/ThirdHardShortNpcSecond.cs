...
namespace GameServerScript.AI.NPC
{
	public class ThirdHardShortNpcSecond : ABrain
	{
		...
		public override void OnBeginNewTurn()
		{
			...
			{
				string oneChat = ThirdHardShortNpcSecond.GetOneChat();
		...
		{
			int num = ThirdHardShortNpcSecond.random.Next(0, ThirdHardShortNpcSecond.listChat.Length);
			return ThirdHardShortNpcSecond.listChat[num];
		}
		...
		public static void LivingSay(List<Living> livings)
		{
			if (livings != null && livings.Count != 0)
			{
				...
				if (count <= 5)
				{
					num = ThirdHardShortNpcSecond.random.Next(0, 2);
				}
				else if (count > 5 && count <= 10)
				{
					num = ThirdHardShortNpcSecond.random.Next(1, 3);
				}
				else
				{
					num = ThirdHardShortNpcSecond.random.Next(1, 4);
				}
				if (num > 0)
				{

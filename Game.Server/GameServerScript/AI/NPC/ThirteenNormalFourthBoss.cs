...
namespace GameServerScript.AI.NPC
{
	public class ThirteenNormalFourthBoss : ABrain
	{
		...
		{
			int num = base.Game.Random.Next(0, ThirteenNormalFourthBoss.AngryChat.Length);
			base.Body.Say(ThirteenNormalFourthBoss.AngryChat[num], 1, 0);
		...
		public void KillAttack(int fx, int tx)
		{
			...
			int num = base.Game.Random.Next(0, ThirteenNormalFourthBoss.KillAttackChat.Length);
			((SimpleBoss)base.Body).Say(ThirteenNormalFourthBoss.KillAttackChat[num], 1, 500);

...
namespace GameServerScript.AI.NPC
{
	public class ThirteenHardNioBoss : ABrain
	{
		...
		private void KillAttack(int fx, int tx)
		{
			...
			int num = base.Game.Random.Next(0, ThirteenHardNioBoss.KillAttackChat.Length);
			base.Body.Say(ThirteenHardNioBoss.KillAttackChat[num], 1, 1000);
		...
		private void AllAttack()
		{
			...
			int num = base.Game.Random.Next(0, ThirteenHardNioBoss.AllAttackChat.Length);
			base.Body.Say(ThirteenHardNioBoss.AllAttackChat[num], 1, 0);
		...
		{
			int num = base.Game.Random.Next(0, ThirteenHardNioBoss.AddBooldChat.Length);
			base.Body.Say(ThirteenHardNioBoss.AddBooldChat[num], 1, 0);
		...
		private void NextAttack()
		{
			...
			int num = base.Game.Random.Next(0, ThirteenHardNioBoss.ShootChat.Length);
			base.Body.Say(ThirteenHardNioBoss.ShootChat[num], 1, 0);
			if (player != null)
			{

...
namespace GameServerScript.AI.NPC
{
	public class NormalKingLast : ABrain
	{
		...
		public void HalfAttack()
		{
			...
			int num = base.Game.Random.Next(0, NormalKingLast.SealChat.Length);
			base.Body.Say(NormalKingLast.AllAttackChat[num], 1, 500);
		...
		public void Summon()
		{
			int num = base.Game.Random.Next(0, NormalKingLast.CallChat.Length);
			base.Body.Say(NormalKingLast.CallChat[num], 1, 0);
		...
		{
			int num = base.Game.Random.Next(0, NormalKingLast.SealChat.Length);
			((SimpleBoss)base.Body).Say(NormalKingLast.SealChat[num], 1, 0);
		...
		public void Angger()
		{
			int num = base.Game.Random.Next(0, NormalKingLast.AngryChat.Length);
			base.Body.Say(NormalKingLast.AngryChat[num], 1, 0);
			base.Body.State = 1;
			this.Dander += 100;
		...
		public void KillAttack(int fx, int mx)
		{
			...
			int num = base.Game.Random.Next(0, NormalKingLast.KillAttackChat.Length);
			((SimpleBoss)base.Body).Say(NormalKingLast.KillAttackChat[num], 1, 500);
			base.Body.PlayMovie("beatB", 2500, 0);

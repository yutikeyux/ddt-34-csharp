...
namespace GameServerScript.AI.NPC
{
	public class BachHo : ABrain
	{
        ...
        "Xin chút Review sương sương về tui"
        };

        private static string[] ShootChat = new string[]{
         "Cái thằng não quốc lộ này..."

        };

        private static string[] KillPlayerChat = new string[]{
         "Cưng có biết vì sao con chó lại hỏi 'Tại Sao?' không?"

        };

        private static string[] CallChat = new string[]{
        "Im đi con heo rừng này"
		...
		{ 
			...
			base.Body.CurrentDamagePlus = 650f;

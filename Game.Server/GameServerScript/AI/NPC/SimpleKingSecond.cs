...
namespace GameServerScript.AI.NPC
{
	public class SimpleKingSecond : ABrain
	{
		...
		private void AllAttack()
		{
			...
			if (this.m_turn == 0)
			{
				int num = base.Game.Random.Next(0, SimpleKingSecond.AllAttackChat.Length);
				base.Body.Say(SimpleKingSecond.AllAttackChat[num], 1, 13000);
			...
			{
				int num = base.Game.Random.Next(0, SimpleKingSecond.AllAttackChat.Length);
				base.Body.Say(SimpleKingSecond.AllAttackChat[num], 1, 0);
		...
		{
			int num = base.Game.Random.Next(0, SimpleKingSecond.KillAttackChat.Length);
			if (this.m_turn == 0)
			{
				base.Body.CurrentDamagePlus = 10f;
				base.Body.Say(SimpleKingSecond.KillAttackChat[num], 1, 13000);
				base.Body.PlayMovie("beat1", 15000, 0);
			...
			{
				base.Body.CurrentDamagePlus = 10f;
				base.Body.Say(SimpleKingSecond.KillAttackChat[num], 1, 0);
		...
		private void ProtectingWall()
		{
			...
			int num = base.Game.Random.Next(0, SimpleKingSecond.WallChat.Length);
			base.Body.Say(SimpleKingSecond.WallChat[num], 1, 0);
		}
		...
		private void NextAttack()
		{
			...
			for (int i = 0; i < num; i++)
			{
				...
				int num2 = base.Game.Random.Next(0, SimpleKingSecond.ShootChat.Length);
				base.Body.Say(SimpleKingSecond.ShootChat[num2], 1, 0);

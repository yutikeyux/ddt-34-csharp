...
namespace GameServerScript.AI.NPC
{
	public class ThirdHardKingThird : ABrain
	{
		...
		public void HalfAttack()
		{
			...
			int num = base.Game.Random.Next(0, ThirdHardKingThird.SealChat.Length);
			base.Body.Say(ThirdHardKingThird.AllAttackChat[num], 1, 500);
		...
		public void Summon()
		{
			int num = base.Game.Random.Next(0, ThirdHardKingThird.CallChat.Length);
			base.Body.Say(ThirdHardKingThird.CallChat[num], 1, 0);
		...
		public void KillAttack(int fx, int mx)
		{
			...
			int num = base.Game.Random.Next(0, ThirdHardKingThird.KillAttackChat.Length);
			((SimpleBoss)base.Body).Say(ThirdHardKingThird.KillAttackChat[num], 1, 500);
			base.Body.PlayMovie("beatC", 2500, 0);

...
namespace GameServerScript.AI.NPC
{
	public class ZYSimpleNpc60016 : ABrain
	{
		...
		public void HalfAttack()
		{
			...
			int num = base.Game.Random.Next(0, ZYSimpleNpc60016.SealChat.Length);
			base.Body.Say(ZYSimpleNpc60016.AllAttackChat[num], 1, 500);
		...
		public void Summon()
		{
			int num = base.Game.Random.Next(0, ZYSimpleNpc60016.CallChat.Length);
			base.Body.Say(ZYSimpleNpc60016.CallChat[num], 1, 0);
		...
		{
			int num = base.Game.Random.Next(0, ZYSimpleNpc60016.SealChat.Length);
			((SimpleBoss)base.Body).Say(ZYSimpleNpc60016.SealChat[num], 1, 0);
		...
		public void KillAttack(int fx, int tx)
		{
			...
			int num = base.Game.Random.Next(0, ZYSimpleNpc60016.KillAttackChat.Length);
			((SimpleBoss)base.Body).Say(ZYSimpleNpc60016.KillAttackChat[num], 1, 500);
			base.Body.PlayMovie("beatB", 2500, 0);

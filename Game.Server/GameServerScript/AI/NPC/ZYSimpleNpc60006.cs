...
namespace GameServerScript.AI.NPC
{
	public class ZYSimpleNpc60006 : ABrain
	{
		...
		public void HalfAttack()
		{
			...
			int num = base.Game.Random.Next(0, ZYSimpleNpc60006.SealChat.Length);
			base.Body.Say(ZYSimpleNpc60006.AllAttackChat[num], 1, 500);
		...
		public void Summon()
		{
			int num = base.Game.Random.Next(0, ZYSimpleNpc60006.CallChat.Length);
			base.Body.Say(ZYSimpleNpc60006.CallChat[num], 1, 0);
		...
		{
			int num = base.Game.Random.Next(0, ZYSimpleNpc60006.SealChat.Length);
			((SimpleBoss)base.Body).Say(ZYSimpleNpc60006.SealChat[num], 1, 0);
		...
		public void KillAttack(int fx, int tx)
		{
			...
			int num = base.Game.Random.Next(0, ZYSimpleNpc60006.KillAttackChat.Length);
			((SimpleBoss)base.Body).Say(ZYSimpleNpc60006.KillAttackChat[num], 1, 500);
			base.Body.PlayMovie("beatB", 2500, 0);

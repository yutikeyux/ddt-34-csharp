...
namespace GameServerScript.AI.NPC
{
	public class ThirdTerrorKingFirst : ABrain
	{
		...
		private void KillAttack(int fx, int tx)
		{
			...
			int num = base.Game.Random.Next(0, ThirdTerrorKingFirst.KillAttackChat.Length);
			base.Body.Say(ThirdTerrorKingFirst.KillAttackChat[num], 0, 1000);
		...
		{
			int num = base.Game.Random.Next(0, ThirdTerrorKingFirst.CallChat.Length);
			base.Body.Say(ThirdTerrorKingFirst.CallChat[num], 0, 3300);
		...
		private void NextAttack()
		{
			...
			int num = base.Game.Random.Next(0, ThirdTerrorKingFirst.ShootChat.Length);
			base.Body.Say(ThirdTerrorKingFirst.ShootChat[num], 0, 0);
			if (player != null)
			{

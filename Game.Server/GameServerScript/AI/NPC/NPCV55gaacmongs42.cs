...
{
    public class NPCV55gaacmongs42 : ABrain
    {
        ...
        private void ProtectingWall()
        {
            if (IsEixt == 0)
            {
                m_wallLeft = ((PVEGame)Game).CreatePhysicalObj(Body.X - 65, 600, "wallLeft", "com.mapobject.asset.WaveAsset_01_left", "1", 1, 0);
                m_wallRight = ((PVEGame)Game).CreatePhysicalObj(Body.X + 65, 600, "wallLeft", "com.mapobject.asset.WaveAsset_01_right", "1", 1, 0);

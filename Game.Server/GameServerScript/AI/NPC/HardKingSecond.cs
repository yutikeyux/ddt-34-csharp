...
namespace GameServerScript.AI.NPC
{
	public class HardKingSecond : ABrain
	{
		...
		private void AllAttack()
		{
			...
			if (this.m_turn == 0)
			{
				int num = base.Game.Random.Next(0, HardKingSecond.AllAttackChat.Length);
				base.Body.Say(HardKingSecond.AllAttackChat[num], 1, 13000);
			...
			{
				int num = base.Game.Random.Next(0, HardKingSecond.AllAttackChat.Length);
				base.Body.Say(HardKingSecond.AllAttackChat[num], 1, 0);
		...
		{
			int num = base.Game.Random.Next(0, HardKingSecond.KillAttackChat.Length);
			if (this.m_turn == 0)
			{
				base.Body.CurrentDamagePlus = 10f;
				base.Body.Say(HardKingSecond.KillAttackChat[num], 1, 13000);
				base.Body.PlayMovie("beat1", 15000, 0);
			...
			{
				base.Body.CurrentDamagePlus = 10f;
				base.Body.Say(HardKingSecond.KillAttackChat[num], 1, 0);
		...
		private void ProtectingWall()
		{
			...
			int num = base.Game.Random.Next(0, HardKingSecond.WallChat.Length);
			base.Body.Say(HardKingSecond.WallChat[num], 1, 0);
		}
		...
		private void NextAttack()
		{
			...
			for (int i = 0; i < num; i++)
			{
				...
				int num2 = base.Game.Random.Next(0, HardKingSecond.ShootChat.Length);
				base.Body.Say(HardKingSecond.ShootChat[num2], 1, 0);
				...
				{
					if (base.Body.ShootPoint(player.X, player.Y, 1, 1000, 10000, 1, 1.5f, 2000))
					{

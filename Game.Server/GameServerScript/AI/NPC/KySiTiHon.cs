...
namespace GameServerScript.AI.NPC
{
	public class KySiTiHon : ABrain
	{
        ...
        "Thằng này Hảooooooooooo"
        };

        private static string[] ShootChat = new string[]{
         "Chùy nhà làm , thơm ngon mời bạn ăn nhaaaaaaaaa"
        ...
        "Uống thuốc đi đừng lên cơn nữa..."

        };

        private static string[] JumpChat = new string[]{
         "Chùy Dũa Nết...Chất lượng cao....Siêu to khổng lồ.."
		...
		{ 
			...
			base.Body.CurrentDamagePlus = 340f;

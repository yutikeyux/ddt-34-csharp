...
namespace GameServerScript.AI.NPC
{
	public class ThirdSimpleKingThird : ABrain
	{
		...
		public void HalfAttack()
		{
			...
			int num = base.Game.Random.Next(0, ThirdSimpleKingThird.SealChat.Length);
			base.Body.Say(ThirdSimpleKingThird.AllAttackChat[num], 1, 500);
		...
		public void Summon()
		{
			int num = base.Game.Random.Next(0, ThirdSimpleKingThird.CallChat.Length);
			base.Body.Say(ThirdSimpleKingThird.CallChat[num], 1, 0);
		...
		public void KillAttack(int fx, int mx)
		{
			...
			int num = base.Game.Random.Next(0, ThirdSimpleKingThird.KillAttackChat.Length);
			((SimpleBoss)base.Body).Say(ThirdSimpleKingThird.KillAttackChat[num], 1, 500);
			base.Body.PlayMovie("beatC", 2500, 0);

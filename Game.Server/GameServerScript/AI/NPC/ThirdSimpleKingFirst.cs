...
namespace GameServerScript.AI.NPC
{
	public class ThirdSimpleKingFirst : ABrain
	{
		...
		private void KillAttack(int fx, int tx)
		{
			...
			int num = base.Game.Random.Next(0, ThirdSimpleKingFirst.KillAttackChat.Length);
			base.Body.Say(ThirdSimpleKingFirst.KillAttackChat[num], 0, 1000);
		...
		{
			int num = base.Game.Random.Next(0, ThirdSimpleKingFirst.CallChat.Length);
			base.Body.Say(ThirdSimpleKingFirst.CallChat[num], 0, 3300);
		...
		{
			((SimpleBoss)base.Body).CreateBoss(this.npcID, 1352, 227, -1, 430, 1, "");
		}
		...
		private void NextAttack()
		{
			...
			int num = base.Game.Random.Next(0, ThirdSimpleKingFirst.ShootChat.Length);
			base.Body.Say(ThirdSimpleKingFirst.ShootChat[num], 0, 0);
			if (player != null)
			{

...
namespace GameServerScript.AI.NPC
{
	public class ThirteenNormalBrotherNpc : ABrain
	{
		...
		public void KillAttack(int fx, int tx)
		{
			...
			int num = base.Game.Random.Next(0, ThirteenNormalBrotherNpc.KillAttackChat.Length);
			((SimpleBoss)base.Body).Say(ThirteenNormalBrotherNpc.KillAttackChat[num], 1, 500);

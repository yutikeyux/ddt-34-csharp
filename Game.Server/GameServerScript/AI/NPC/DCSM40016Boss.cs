...
namespace GameServerScript.AI.NPC
{
	public class DCSM40016Boss : ABrain
	{
		...
		{
			base.Body.Direction = base.Game.FindlivingbyDir(base.Body);
			base.Body.MoveTo(850, 470, "fly", 1000, "", 16, new LivingCallBack(this.ChangeDirection));
		}
		...
		private void CallHopquaidi()
		{
			...
			int num = base.Game.Random.Next(0, DCSM40016Boss.ShootChat.Length);
			base.Body.Say(DCSM40016Boss.ShootChat[num], 1, 0);
		...
		{
			int num = base.Game.Random.Next(0, DCSM40016Boss.AddBooldChat.Length);
			base.Body.Say(DCSM40016Boss.AddBooldChat[num], 1, 0);
			base.Body.Direction = base.Game.FindlivingbyDir(base.Body);
		...
		private void KillAttack(int fx, int tx)
		{
			...
			int num = base.Game.Random.Next(0, DCSM40016Boss.KillAttackChat.Length);
			base.Body.Say(DCSM40016Boss.KillAttackChat[num], 1, 1000);

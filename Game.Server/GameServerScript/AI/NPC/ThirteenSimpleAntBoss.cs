...
namespace GameServerScript.AI.NPC
{
	public class ThirteenSimpleAntBoss : ABrain
	{
		...
		{
			int num = base.Game.Random.Next(0, ThirteenSimpleAntBoss.KillAttackChat.Length);
			base.Body.Say(ThirteenSimpleAntBoss.KillAttackChat[num], 1, 1000);
		...
		private void PersonalAttack()
		{
			...
			if (player != null)
			{
				...
				int num = base.Game.Random.Next(0, ThirteenSimpleAntBoss.KillPlayerChat.Length);
				base.Body.Say(ThirteenSimpleAntBoss.KillPlayerChat[num], 1, 0);
		...
		private void Plain()
		{
			int num = base.Game.Random.Next(0, ThirteenSimpleAntBoss.ShootChat.Length);
			base.Body.Say(ThirteenSimpleAntBoss.ShootChat[num], 1, 0);
		...
		public override void OnKillPlayerSay()
		{
			...
			int num = base.Game.Random.Next(0, ThirteenSimpleAntBoss.KillPlayerChat.Length);
			base.Body.Say(ThirteenSimpleAntBoss.KillPlayerChat[num], 1, 0, 2000);
		}
		...
		{
			int num = base.Game.Random.Next(0, ThirteenSimpleAntBoss.ShootedChat.Length);
			if (this.isSay == 0 && base.Body.IsLiving)
			{
				base.Body.Say(ThirteenSimpleAntBoss.ShootedChat[num], 1, 900, 0);
				this.isSay = 1;
			}
			if (!base.Body.IsLiving)
			{
				num = base.Game.Random.Next(0, ThirteenSimpleAntBoss.DiedChat.Length);
				base.Body.Say(ThirteenSimpleAntBoss.DiedChat[num], 1, 100, 2000);
			}
		}
	}
}

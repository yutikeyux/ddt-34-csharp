...
namespace GameServerScript.AI.NPC
{
	public class HardKingLast : ABrain
	{
		...
		public void HalfAttack()
		{
			...
			int num = base.Game.Random.Next(0, HardKingLast.SealChat.Length);
			base.Body.Say(HardKingLast.AllAttackChat[num], 1, 500);
		...
		public void Summon()
		{
			int num = base.Game.Random.Next(0, HardKingLast.CallChat.Length);
			base.Body.Say(HardKingLast.CallChat[num], 1, 0);
		...
		{
			int num = base.Game.Random.Next(0, HardKingLast.SealChat.Length);
			((SimpleBoss)base.Body).Say(HardKingLast.SealChat[num], 1, 0);
		...
		public void Angger()
		{
			int num = base.Game.Random.Next(0, HardKingLast.AngryChat.Length);
			base.Body.Say(HardKingLast.AngryChat[num], 1, 0);
			base.Body.State = 1;
			this.Dander += 100;
		...
		public void KillAttack(int fx, int mx)
		{
			...
			int num = base.Game.Random.Next(0, HardKingLast.KillAttackChat.Length);
			((SimpleBoss)base.Body).Say(HardKingLast.KillAttackChat[num], 1, 500);
			base.Body.PlayMovie("beatB", 2500, 0);

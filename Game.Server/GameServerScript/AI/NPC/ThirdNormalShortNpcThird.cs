...
namespace GameServerScript.AI.NPC
{
	public class ThirdNormalShortNpcThird : ABrain
	{
		...
		public override void OnBeginNewTurn()
		{
			...
			{
				string oneChat = ThirdNormalShortNpcThird.GetOneChat();
		...
		{
			int num = ThirdNormalShortNpcThird.random.Next(0, ThirdNormalShortNpcThird.listChat.Length);
			return ThirdNormalShortNpcThird.listChat[num];
		}
		...
		public static void LivingSay(List<Living> livings)
		{
			if (livings != null && livings.Count != 0)
			{
				...
				if (count <= 5)
				{
					num = ThirdNormalShortNpcThird.random.Next(0, 2);
				}
				else if (count > 5 && count <= 10)
				{
					num = ThirdNormalShortNpcThird.random.Next(1, 3);
				}
				else
				{
					num = ThirdNormalShortNpcThird.random.Next(1, 4);
				}
				if (num > 0)
				{

...
namespace GameServerScript.AI.NPC
{
	public class ThirteenNormalShadowBoss : ABrain
	{
		...
		{
			int num = base.Game.Random.Next(0, ThirteenNormalShadowBoss.AngryChat.Length);
			base.Body.Say(ThirteenNormalShadowBoss.AngryChat[num], 1, 0);
		...
		{
			base.Body.CurrentDamagePlus = 10f;
			int num = base.Game.Random.Next(0, ThirteenNormalShadowBoss.KillAttackChat.Length);
			((SimpleBoss)base.Body).Say(ThirteenNormalShadowBoss.KillAttackChat[num], 1, 500);

...
namespace GameServerScript.AI.NPC
{
	public class NewTrainingBoss22001 : ABrain
	{
		...
		private void PersonalAttack()
		{
			...
			if (num > 30)
			{
				base.Body.MoveTo(base.Body.X + num * array[1], base.Body.Y, "happy", 1000, "", ((SimpleBoss)base.Body).NpcInfo.speed, new LivingCallBack(this.NextAttack));
			}
			else
			{
				base.Body.MoveTo(base.Body.X + num * array[0], base.Body.Y, "happy", 1000, "", ((SimpleBoss)base.Body).NpcInfo.speed, new LivingCallBack(this.NextAttack));
			}
		}

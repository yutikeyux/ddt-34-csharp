...
{
	public class MESGaacmongs2 : AMissionControl
	{
		private SimpleBoss boss = null;

		private int npcID = 0;

		private int bossID = 560004;
		...
		public override void OnStartGame()
		{
			...
			this.boss = base.Game.CreateBoss(this.bossID, 860, 519, -1, 1, "standA", config);

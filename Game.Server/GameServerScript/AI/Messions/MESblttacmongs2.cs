...
{
    public class MESblttacmongs2 : AMissionControl
    {
        ...
        private int npcID = 3105;
		
		private int npcID1 = 36003;

        private int npcID2 = 3001;

        private int bossId = 3308;

        private int countSpawnNpc = 5;
        ...
        public void CreateStarGame()
        {
            ...
            config2.IsHelper = true;
            config2.ReduceBloodStart = 2;
            boss = Game.CreateBoss(npcID1, 1100, 444, -1, 1, "born", config);
            boss2 = Game.CreateBoss(npcID1, 1400, 444, -1, 1, "born", config2);
            ...
            boss2.FallFrom(boss2.X, boss2.Y, "", 0, 0, 1000, null);
            CreateBoss();
            ...
            boss2.Say(LanguageMgr.GetTranslation("Dcm chung mày hồi máu cho t"), 0, 1500, 0);

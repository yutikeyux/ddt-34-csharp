...
{
    public class TiTanHoangMacDeS1 : AMissionControl
    {
        private List<SimpleNpc> list_0 = new List<SimpleNpc>();

        private int BossID = 780031;

        private int NpcID = 780112;

        private int[] BossPos = new int[2] { 1029,217 };

        private int kill = 0;

        private int MapID = 40022;

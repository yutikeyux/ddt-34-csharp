...
namespace GameServerScript.AI.Messions
{
    public class GT1172 : AMissionControl
    {
        ...
        public override void DoOther()
        {
            ...
            if (flag)
            {
                int num = base.Game.Random.Next(0, GT1172.Sohbet_1.Length);
                bool flag2 = this.Balufu != null;
                if (flag2)
                {
                    this.Balufu.Say(GT1172.Sohbet_1[num], 0, 0);
                }
            }
        }
        public override void OnShooted()
        {
            ...
            if (flag)
            {
                int num = base.Game.Random.Next(0, GT1172.Sohbet_2.Length);
                this.Balufu.Say(GT1172.Sohbet_2[num], 0, 1500);
                this.int_0 = 1;
            }
        }
        public GT1172()

...
{
    public class NguaMotSungDeS1 : AMissionControl
    {
        private List<SimpleNpc> list_0 = new List<SimpleNpc>();

        private int BossID = 50216;

        private int[] BossPos = new int[2] { 817,595 };

        private int kill = 0;

        private int MapID = 1514;
        ...
        public override void OnPrepareNewSession()
        {
            ...
            //base.Game.AddLoadingFile(2, "image/skilleffect/effect070.swf", "blastOutMovie4");
            int[] bossID = { BossID };
        ...
        {
            base.OnStartGame();
            m_king = Game.CreateBoss(this.BossID, BossPos[0], BossPos[1], 1, 1, "born");

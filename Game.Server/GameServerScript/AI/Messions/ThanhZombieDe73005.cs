...
{
    public class ThanhZombieDe73005 : AMissionControl
    {
        private SimpleBoss boss = null;
        private int bossID = 73005;
        ...
        public override void OnPrepareNewSession()
        {
            ...
            Game.AddLoadingFile(2, "image/game/effect/15/274c.swf", "asset.game.fifteen.274c");
            //Game.AddLoadingFile(2, "image/game/effect/15/305d.swf", "asset.game.fifteen.305d");
            Game.SetMap(1209);			
        }
        ...
        {
            base.OnStartGame();
            boss = Game.CreateBoss(bossID, 1480, 1020, -1, 1, "");

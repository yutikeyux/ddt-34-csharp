...
{
    public class MESblttacmongs4 : AMissionControl
    {
        ...
        private int m_state = 36006;

        private int turn = 0;

        private int firstBossID = 36006;

        private int secondBossID = 36007;

        private int npcID = 36010;

        private int npcID3 = 3318;

        private int npcID2 = 33099;

...
{
	public class LoopholeSpaceSimpleNPC : AMissionControl
	{
		...
		public override void OnStartGame()
		{
			...
			{
				this.someNpc.Add(base.Game.CreateNpc(this.npcIDs[num], 1325, 400, 1, -1));
			}
			num = base.Game.Random.Next(0, this.npcIDs.Length);
			if (this.npcIDs[num] == 71080)
			{
			...
			{
				this.someNpc.Add(base.Game.CreateNpc(this.npcIDs[num], 1360, 400, 1, -1));
			}
			num = base.Game.Random.Next(0, this.npcIDs.Length);
			if (this.npcIDs[num] == 71080)
			{
			...
			{
				this.someNpc.Add(base.Game.CreateNpc(this.npcIDs[num], 1410, 400, 1, -1));
			}
			num = base.Game.Random.Next(0, this.npcIDs.Length);
			if (this.npcIDs[num] == 71080)
			{
			...
			{
				this.someNpc.Add(base.Game.CreateNpc(this.npcIDs[num], 1475, 400, 1, -1));
			}
		}
			...
			if (base.Game.TurnIndex > 1 && base.Game.CurrentPlayer.Delay > base.Game.PveGameDelay)
			{
				if (base.Game.GetLivedLivings().Count < 10)
				{
					for (int i = 0; i < 10 - base.Game.GetLivedLivings().Count; i++)
					{
						...
						{
							this.someNpc.Add(base.Game.CreateNpc(this.npcIDs[0], x, 400, 1, 1));
						}
					}
				}
			}

...
namespace GameServerScript.AI.Messions
{
    public class GK1272 : AMissionControl
    {
        ...
        public override void DoOther()
        {
            ...
            if (flag)
            {
                int num = base.Game.Random.Next(0, GK1272.Sohbet_1.Length);
                bool flag2 = this.Balufu != null;
                if (flag2)
                {
                    this.Balufu.Say(GK1272.Sohbet_1[num], 0, 0);
                }
            }
        }
        public override void OnShooted()
        {
            ...
            if (flag)
            {
                int num = base.Game.Random.Next(0, GK1272.Sohbet_2.Length);
                this.Balufu.Say(GK1272.Sohbet_2[num], 0, 1500);
                this.int_0 = 1;
            }
        }
        public GK1272()

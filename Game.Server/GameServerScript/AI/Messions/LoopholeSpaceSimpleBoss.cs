...
{
	public class LoopholeSpaceSimpleBoss : AMissionControl
	{
		...
		private int m_state = 71081;

		private int turn = 0;

		private int firstBossID = 71081;

		private int secondBossID = 71082;
		...
		{
			base.OnStartGame();
			this.boss = base.Game.CreateBoss(this.m_state, 910, 800, -1, 0, "");

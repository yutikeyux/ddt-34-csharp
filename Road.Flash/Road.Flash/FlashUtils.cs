...
namespace Road.Flash
{
    public class FlashUtils
    {
        ...
        public static XElement CreateGMActivityInfo(GmActivityInfo gmActivityInfo)
        {
            return new XElement("Activity", new XAttribute("activityId", gmActivityInfo.activityId), new XAttribute("activityName", gmActivityInfo.activityName), new XAttribute("activityType", gmActivityInfo.activityType), new XAttribute("activityChildType", gmActivityInfo.activityChildType), new XAttribute("getWay", gmActivityInfo.getWay), new XAttribute("desc", gmActivityInfo.desc ?? ""), new XAttribute("rewardDesc", gmActivityInfo.rewardDesc ?? ""), new XAttribute("beginTime", gmActivityInfo.beginTime.ToString("yyyy-MM-dd HH:mm:ss")), new XAttribute("beginShowTime", gmActivityInfo.beginShowTime.ToString("yyyy-MM-dd HH:mm:ss")), new XAttribute("endTime", gmActivityInfo.endTime.ToString("yyyy-MM-dd HH:mm:ss")), new XAttribute("endShowTime", gmActivityInfo.endShowTime.ToString("yyyy-MM-dd HH:mm:ss")), new XAttribute("icon", gmActivityInfo.icon), new XAttribute("isContinue", gmActivityInfo.isContinue), new XAttribute("status", gmActivityInfo.status), new XAttribute("remain1", gmActivityInfo.remain1), new XAttribute("remain2", gmActivityInfo.remain2 ?? ""));
        }

        public static XElement CreateGMGiftInfo(GmGiftInfo gmGiftInfo)
        {
            return new XElement("Gift", new XAttribute("giftbagId", gmGiftInfo.giftbagId), new XAttribute("activityId", gmGiftInfo.activityId), new XAttribute("rewardMark", gmGiftInfo.rewardMark), new XAttribute("giftbagOrder", gmGiftInfo.giftbagOrder));
        }

        public static XElement CreateGMConditionInfo(GmActiveConditionInfo gmConditionInfo)
        {
            return new XElement("Condition", new XAttribute("giftbagId", gmConditionInfo.giftbagId), new XAttribute("conditionIndex", gmConditionInfo.conditionIndex), new XAttribute("conditionValue", gmConditionInfo.conditionValue), new XAttribute("remain1", gmConditionInfo.remain1), new XAttribute("remain2", gmConditionInfo.remain2 ?? ""));
        }

        public static XElement CreateGMRewardInfo(GmActiveRewardInfo gmRewardInfo)
        {
            return new XElement("Reward", new XAttribute("giftId", gmRewardInfo.giftId), new XAttribute("templateId", gmRewardInfo.templateId), new XAttribute("count", gmRewardInfo.count), new XAttribute("isBind", gmRewardInfo.isBind), new XAttribute("occupationOrSex", gmRewardInfo.occupationOrSex), new XAttribute("rewardType", gmRewardInfo.rewardType), new XAttribute("validDate", gmRewardInfo.validDate), new XAttribute("property", gmRewardInfo.property), new XAttribute("remain1", gmRewardInfo.remain1 ?? ""));
        }
        ...
        {
            return new XElement("Active"
                 , new XAttribute("ActiveID", info.ActiveID)
                 , new XAttribute("SubID", info.SubID)
                 , new XAttribute("IsOpen", info.IsOpen)
                 , new XAttribute("StartDate", info.StartDate.ToString("yyyy-MM-dd HH:mm:ss"))//"2013-12-19 00:00:00")
                 , new XAttribute("StartTime", info.StartTime.ToString("yyyy-MM-dd HH:mm:ss"))
        ...
        public static XElement CreateActiveConditionInfo(SubActiveConditionInfo info)
        {
            return new XElement("Condition"
                , new XAttribute("ActiveID", info.ActiveID)
                , new XAttribute("SubID", info.SubID)
                , new XAttribute("ConditionID", info.ConditionID)
                , new XAttribute("Type", info.Type)
                , new XAttribute("Value", info.Value)
        ...
        public static XElement CreatePetLevels(PetLevel info)
        {
            return new XElement("item",
            new XAttribute("GP", info.GP),
            new XAttribute("Level", info.Level));

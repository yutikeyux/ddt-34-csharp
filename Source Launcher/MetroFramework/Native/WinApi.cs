...
namespace MetroFramework.Native
{
	...
	internal static class WinApi
	{
		public struct POINT
		{
			...
			internal static object kje4l5KDpBO6oEfpYMk;
			...
			internal static void vWLDoSKJ2TdoVrQknWL()
			{
			}

			internal static bool gMW0FsKhUwKSH7bY2mT()
			{
				return kje4l5KDpBO6oEfpYMk == null;
			}
		}
		...
		public struct SIZE
		{
			...
			internal static object zlxvCoK8IeXMLbY5CXw;
			...
			internal static void LHEYYxK9sm5OV0ZirBa()
			{
			}

			internal static bool b6kXxKKKnMxath9mO3l()
			{
				return zlxvCoK8IeXMLbY5CXw == null;
			}
		}
		...
		public struct RECT
		{
			...
			internal static object lr5BwKKWlwYdaIGSP1W;
			...
			internal static void JfRV1EKyl77eCpHKyDf()
			{
			}

			internal static bool HZIuHIK3EPFCFiLMdsP()
			{
				return lr5BwKKWlwYdaIGSP1W == null;
			}
		}
		...
		private static object dThLI3K6oaypQarQyAq;
		...
		internal static bool LaY9EoKS1X3ZcWki9FB()
		{
			return dThLI3K6oaypQarQyAq == null;
		}
	}
}

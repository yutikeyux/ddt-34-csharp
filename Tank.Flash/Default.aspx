      ...
      body
   	...
   	<script type="text/javascript">
		function getSWF(){
			...
			if (window.ActiveXObject && ua.match(/msie ([\d.]+)/)[1])
			        return $("#7road-ddt-gameIE")[0];
		   	else 
		    		return $("#7road-ddt-gameFF")[0];
		    //else if (document.getBoxObjectFor)
		    //        Sys.firefox = ua.match(/firefox\/([\d.]+)/)[1]
		}
		function checkLoginType()
		{
			getSWF().setLoginType(0);
		}
	</script>
</head>
<body scroll="no">
                    ...
                    <tr>
                        <td align="center">
                            <object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" id="7road-ddt-game"
                                ...
                                <param name="FlashVars" value="<%=Content %>&config=<%=Config%>" />
                                <param name="allowScriptAccess" value="always" />
                                <embed id="7road-ddt-gameFF" flashvars="<%=AutoParam %>" src="<%=Flash %>Loading.swf?<%=Content %>&v=5498628&config=<%=Config %>"

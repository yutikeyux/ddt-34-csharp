...
namespace Bussiness
{
	...
	{
		// Token: 0x06000026 RID: 38 RVA: 0x00003E18 File Offset: 0x00002018
		...
		// Token: 0x06000027 RID: 39 RVA: 0x00003F3C File Offset: 0x0000213C
		...
		// Token: 0x06000028 RID: 40 RVA: 0x0000401C File Offset: 0x0000221C
		...
		// Token: 0x06000029 RID: 41 RVA: 0x00004178 File Offset: 0x00002378
		...
		// Token: 0x0600002A RID: 42 RVA: 0x00004338 File Offset: 0x00002538
		...
		// Token: 0x0600002B RID: 43 RVA: 0x000046D0 File Offset: 0x000028D0
		...
		// Token: 0x0600002C RID: 44 RVA: 0x00004868 File Offset: 0x00002A68
		...
		// Token: 0x0600002F RID: 47 RVA: 0x00004D84 File Offset: 0x00002F84
		...
		// Token: 0x06000030 RID: 48 RVA: 0x00004FE0 File Offset: 0x000031E0
		...
		// Token: 0x06000031 RID: 49 RVA: 0x000050FC File Offset: 0x000032FC
		...
		// Token: 0x06000032 RID: 50 RVA: 0x00005244 File Offset: 0x00003444
		public bool ConsortiaRichAdd(int consortiID, ref int riches)
		{
			return this.ConsortiaRichAdd(consortiID, ref riches, 0, "");
		}

		// Token: 0x06000033 RID: 51 RVA: 0x00005264 File Offset: 0x00003464
		...
		// Token: 0x06000035 RID: 53 RVA: 0x00005450 File Offset: 0x00003650
		...
		// Token: 0x06000036 RID: 54 RVA: 0x0000553C File Offset: 0x0000373C
		...
		// Token: 0x06000037 RID: 55 RVA: 0x00005630 File Offset: 0x00003830
		...
		// Token: 0x06000038 RID: 56 RVA: 0x00005734 File Offset: 0x00003934
		...
		// Token: 0x06000039 RID: 57 RVA: 0x000057F0 File Offset: 0x000039F0
		...
		// Token: 0x0600003A RID: 58 RVA: 0x00005968 File Offset: 0x00003B68
		...
		// Token: 0x0600003B RID: 59 RVA: 0x00005B44 File Offset: 0x00003D44
		...
		// Token: 0x0600003C RID: 60 RVA: 0x00005D68 File Offset: 0x00003F68
		...
		// Token: 0x0600003D RID: 61 RVA: 0x00005EE8 File Offset: 0x000040E8
		public ConsortiaAllyInfo[] GetConsortiaAllyPage(int page, int size, ref int total, int order, int consortiaID, int state, string name)
		{
			...
			try
			{
				...
				foreach (object obj in base.GetPage("Consortia", queryWhere, page, size, "*", "ConsortiaID", "ConsortiaID", ref total).Rows)
				{
					...
					bool flag3 = consortiaByAlly.ContainsKey(item.Consortia1ID);
					if (flag3)
					{
		...
		// Token: 0x0600003E RID: 62 RVA: 0x00006258 File Offset: 0x00004458
		public ConsortiaApplyAllyInfo[] GetConsortiaApplyAllyPage(int page, int size, ref int total, int order, int consortiaID, int applyID, int state)
		{
			...
			try
			{
				...
				fdOreder += ",ID ";
				foreach (object obj5 in base.GetPage("V_Consortia_Apply_Ally", queryWhere, page, size, "*", fdOreder, "ID", ref total).Rows)
				{
		...
		// Token: 0x0600003F RID: 63 RVA: 0x000065E8 File Offset: 0x000047E8
		public ConsortiaApplyUserInfo[] GetConsortiaApplyUserPage(int page, int size, ref int total, int order, int consortiaID, int applyID, int userID)
		{
			...
			try
			{
				...
				foreach (object obj5 in base.GetPage("V_Consortia_Apply_Users", queryWhere, page, size, "*", fdOreder, "ID", ref total).Rows)
				{
					DataRow row = (DataRow)obj5;
		...
		// Token: 0x06000040 RID: 64 RVA: 0x00006974 File Offset: 0x00004B74
		public Dictionary<int, int> GetConsortiaByAlly(int consortiaID)
		{
			...
			try
			{
				...
				while (resultDataReader.Read())
				{
					bool flag = (int)resultDataReader["Consortia1ID"] != consortiaID;
					if (flag)
					{
		...
		// Token: 0x06000041 RID: 65 RVA: 0x00006AAC File Offset: 0x00004CAC
		...
		// Token: 0x06000042 RID: 66 RVA: 0x00006BA4 File Offset: 0x00004DA4
		public ConsortiaDutyInfo[] GetConsortiaDutyPage(int page, int size, ref int total, int order, int consortiaID, int dutyID)
		{
			...
			try
			{
				...
				fdOreder += ",DutyID ";
				foreach (object obj4 in base.GetPage("Consortia_Duty", queryWhere, page, size, "*", fdOreder, "DutyID", ref total).Rows)
				{
		...
		// Token: 0x06000043 RID: 67 RVA: 0x00006DCC File Offset: 0x00004FCC
		public ConsortiaEquipControlInfo[] GetConsortiaEquipControlPage(int page, int size, ref int total, int order, int consortiaID, int level, int type)
		{
			...
			try
			{
				...
				foreach (object obj5 in base.GetPage("Consortia_Equip_Control", queryWhere, page, size, "*", fdOreder, "ConsortiaID", ref total).Rows)
				{
					DataRow row = (DataRow)obj5;
		...
		// Token: 0x06000044 RID: 68 RVA: 0x00006FE4 File Offset: 0x000051E4
		public ConsortiaEquipControlInfo GetConsortiaEquipRiches(int consortiaID, int Level, int type)
		{
			...
			if (flag3)
			{
				result = new ConsortiaEquipControlInfo
				{
		...
		// Token: 0x06000045 RID: 69 RVA: 0x00007168 File Offset: 0x00005368
		public ConsortiaEventInfo[] GetConsortiaEventPage(int page, int size, ref int total, int order, int consortiaID)
		{
			...
			try
			{
				...
				foreach (object obj3 in base.GetPage("Consortia_Event", queryWhere, page, size, "*", fdOreder, "ID", ref total).Rows)
				{
					DataRow row = (DataRow)obj3;
		...
		// Token: 0x06000046 RID: 70 RVA: 0x0000734C File Offset: 0x0000554C
		public ConsortiaInviteUserInfo[] GetConsortiaInviteUserPage(int page, int size, ref int total, int order, int userID, int inviteID)
		{
			...
			try
			{
				...
				fdOreder += ",ID ";
				foreach (object obj4 in base.GetPage("V_Consortia_Invite", queryWhere, page, size, "*", fdOreder, "ID", ref total).Rows)
				{
					DataRow row = (DataRow)obj4;
		...
		// Token: 0x06000047 RID: 71 RVA: 0x00007688 File Offset: 0x00005888
		public ConsortiaInfo[] GetConsortiaPage(int page, int size, ref int total, int order, string name, int consortiaID, int level, int openApply)
		{
			...
			try
			{
				...
				foreach (object obj in base.GetPage("V_Consortia", queryWhere, page, size, "*", fdOreder, "ConsortiaID", ref total).Rows)
				{
					DataRow row = (DataRow)obj;
		...
		// Token: 0x06000048 RID: 72 RVA: 0x00007C5C File Offset: 0x00005E5C
		...
		// Token: 0x06000049 RID: 73 RVA: 0x00007FCC File Offset: 0x000061CC
		...
		// Token: 0x0600004A RID: 74 RVA: 0x000082BC File Offset: 0x000064BC
		...
		// Token: 0x0600004B RID: 75 RVA: 0x000082F4 File Offset: 0x000064F4
		public ConsortiaUserInfo[] GetConsortiaUsersPage(int page, int size, ref int total, int order, int consortiaID, int userID, int state)
		{
			...
			try
			{
				...
				foreach (object obj in base.GetPage("V_Consortia_Users", queryWhere, page, size, "*", fdOreder, "ID", ref total).Rows)
				{
					DataRow row = (DataRow)obj;
		...
		// Token: 0x0600004C RID: 76 RVA: 0x000088A0 File Offset: 0x00006AA0
		public bool PassConsortiaApplyAlly(int applyID, int userID, int consortiaID, ref int tempID, ref int state, ref string msg)
		{
			...
			try
			{
				...
				array[2] = new SqlParameter("@ConsortiaID", consortiaID);
				array[3] = new SqlParameter("@tempID", tempID);
				SqlParameter[] sqlParameters = array;
				sqlParameters[3].Direction = ParameterDirection.InputOutput;
		...
		// Token: 0x0600004D RID: 77 RVA: 0x00008A18 File Offset: 0x00006C18
		...
		// Token: 0x0600004E RID: 78 RVA: 0x00009078 File Offset: 0x00007278
		...
		// Token: 0x0600004F RID: 79 RVA: 0x000096B8 File Offset: 0x000078B8
		public bool RenameConsortia(int ConsortiaID, string nickName, string newNickName)
		{
			...
			try
			{
				...
				result = this.db.RunProcedure("SP_Users_RenameConsortia", para);
		...
		// Token: 0x06000050 RID: 80 RVA: 0x0000977C File Offset: 0x0000797C
		...
		// Token: 0x06000051 RID: 81 RVA: 0x00009868 File Offset: 0x00007A68
		...
		// Token: 0x06000052 RID: 82 RVA: 0x00009938 File Offset: 0x00007B38
		...
		// Token: 0x06000053 RID: 83 RVA: 0x00009B84 File Offset: 0x00007D84
		...
		// Token: 0x06000054 RID: 84 RVA: 0x00009C6C File Offset: 0x00007E6C
		...
		// Token: 0x06000055 RID: 85 RVA: 0x00009EA8 File Offset: 0x000080A8
		...
		// Token: 0x06000056 RID: 86 RVA: 0x0000A030 File Offset: 0x00008230
		...
		// Token: 0x06000057 RID: 87 RVA: 0x0000A118 File Offset: 0x00008318
		...
		// Token: 0x06000058 RID: 88 RVA: 0x0000A204 File Offset: 0x00008404
		...
		// Token: 0x06000059 RID: 89 RVA: 0x0000A460 File Offset: 0x00008660
		...
		// Token: 0x0600005A RID: 90 RVA: 0x0000A55C File Offset: 0x0000875C
		...
		// Token: 0x0600005B RID: 91 RVA: 0x0000A648 File Offset: 0x00008848
		...
		// Token: 0x0600005C RID: 92 RVA: 0x0000A74C File Offset: 0x0000894C
		...
		// Token: 0x0600005D RID: 93 RVA: 0x0000A850 File Offset: 0x00008A50
		...
		// Token: 0x0600005F RID: 95 RVA: 0x0000AA58 File Offset: 0x00008C58
		...
		// Token: 0x06000060 RID: 96 RVA: 0x0000AB5C File Offset: 0x00008D5C
		...
		// Token: 0x06000061 RID: 97 RVA: 0x0000AF5C File Offset: 0x0000915C
		public void RemoveAllConsortiaBattleRank()
		{
			try
			{
				this.db.RunProcedure("SP_ConsortiaWarRank_RemoveAll");
			}
			catch (Exception e)
			{
				bool isErrorEnabled = BaseBussiness.log.IsErrorEnabled;
		...
		// Token: 0x06000062 RID: 98 RVA: 0x0000AFB4 File Offset: 0x000091B4
		public void RemoveAllConsortiaBattlePlayerRank()
		{
			try
			{
				this.db.RunProcedure("SP_ConsortiaWarPlayerRank_RemoveAll");
			}
			catch (Exception e)
			{
				bool isErrorEnabled = BaseBussiness.log.IsErrorEnabled;
		...
		// Token: 0x06000063 RID: 99 RVA: 0x0000B00C File Offset: 0x0000920C
		public bool AddConsortiaBattleRank(ConsortiaWarRankInfo guild)
		{
			...
			try
			{
				SqlParameter[] para = new SqlParameter[]
				{
					new SqlParameter("@ConsortiaID", guild.ConsortiaID),
					new SqlParameter("@ConsortiaName", guild.ConsortiaName),
					new SqlParameter("@Rank", guild.Rank),
					new SqlParameter("@Score", guild.Score),
					new SqlParameter("@TimeCreate", guild.TimeCreate),
					new SqlParameter("@Result", SqlDbType.Int)
				};
				para[5].Direction = ParameterDirection.ReturnValue;
				this.db.RunProcedure("SP_ConsortiaWarRank_Add", para);
		...
		// Token: 0x06000064 RID: 100 RVA: 0x0000B114 File Offset: 0x00009314
		public bool AddConsortiaBattlePlayerRank(ConsortiaWarPlayerRankInfo player)
		{
			...
			try
			{
				SqlParameter[] para = new SqlParameter[]
				{
					...
					new SqlParameter("@ZoneName", player.ZoneName),
					new SqlParameter("@ZoneID", player.ZoneID),
					new SqlParameter("@TimeCreate", player.TimeCreate),
					new SqlParameter("@Result", SqlDbType.Int)
				};
				para[7].Direction = ParameterDirection.ReturnValue;
				this.db.RunProcedure("SP_ConsortiaWarPlayerRank_Add", para);
		...
		// Token: 0x06000065 RID: 101 RVA: 0x0000B248 File Offset: 0x00009448
		public ConsortiaInfo[] GetRankWeekRichesConsortias()
		{
			...
			try
			{
				this.db.GetReader(ref reader, "SP_Consortia_Rank_Week_Riches");
				while (reader.Read())
				{
			...
			catch (Exception e)
			{
				...
				if (isErrorEnabled)
				{
					BaseBussiness.log.Error("GetRankWeekRichesConsortias", e);
				}
			}
			finally
			{
		...
		// Token: 0x06000066 RID: 102 RVA: 0x0000B498 File Offset: 0x00009698
		public ConsortiaInfo[] GetRankDayRichesConsortias()
		{
			...
			try
			{
				this.db.GetReader(ref reader, "SP_Consortia_Rank_Day_Riches");
				while (reader.Read())
				{
					infos.Add(new ConsortiaInfo
					{
			...
			catch (Exception e)
			{
				...
				if (isErrorEnabled)
				{
					BaseBussiness.log.Error("GetRankDayRichesConsortias", e);
				}
			}
			finally
			{
		...
		// Token: 0x06000067 RID: 103 RVA: 0x0000B6E8 File Offset: 0x000098E8

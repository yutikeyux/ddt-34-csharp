...
namespace Bussiness
{
    public abstract class GameProperties
    {
        ...
        [ConfigPropertyAttribute("ItemDevelopPrice", "ItemDevelopPrice", 35)]
        ...
        [ConfigPropertyAttribute("PRICE_STRENGHTN_GOLD", "PRICE_STRENGHTN_GOLD", 10000)]
        public static readonly int PRICE_STRENGHTN_GOLD;

        [ConfigPropertyAttribute("ChristmasBeginDate", "ChristmasBeginDate", "2013/12/17 0:00:00")]
        public static readonly string ChristmasBeginDate;

        [ConfigPropertyAttribute("ChristmasEndDate", "ChristmasEndDate", "2013/12/25 0:00:00")]
        public static readonly string ChristmasEndDate;

        [ConfigPropertyAttribute("ChristmasGifts", "ChristmasGifts", "201148,10|201149,35|201150,70|201151,120|201152,220|201153,370|201154,650|201155,1000|201156,100")]
        public static readonly string ChristmasGifts;

        [ConfigPropertyAttribute("ChristmasGiftsMaxNum", "ChristmasGiftsMaxNum", 1000)]
        public static readonly int ChristmasGiftsMaxNum;

        [ConfigPropertyAttribute("ChristmasBuildSnowmanDoubleMoney", "ChristmasBuildSnowmanDoubleMoney", 10)]
        public static readonly int ChristmasBuildSnowmanDoubleMoney;

        [ConfigPropertyAttribute("ChristmasBuyTimeMoney", "ChristmasBuyTimeMoney", 150)]
        public static readonly int ChristmasBuyTimeMoney;

        [ConfigPropertyAttribute("ChristmasMinute", "ChristmasMinute", 60)]
        public static readonly int ChristmasMinute;

        [ConfigPropertyAttribute("ChristmasBuyMinute", "ChristmasBuyMinute", 10)]
        public static readonly int ChristmasBuyMinute;

        [ConfigPropertyAttribute("PyramidBeginTime", "PyramidBeginTime", "2013/12/17 0:00:00")]
        public static readonly string PyramidBeginTime;

        [ConfigPropertyAttribute("PyramidEndTime", "NewChickenEndTime", "2050/12/25 0:00:00")]
        public static readonly string PyramidEndTime;

        [ConfigPropertyAttribute("PyramidRevivePrice", "PyramidRevivePrice", "10000, 30000, 50000")]
        public static readonly string PyramidRevivePrice;

        [ConfigPropertyAttribute("PyramydTurnCardPrice", "PyramydTurnCardPrice", 5000)]

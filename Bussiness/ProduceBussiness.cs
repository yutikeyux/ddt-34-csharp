...
namespace Bussiness
{
    public class ProduceBussiness : BaseCrossBussiness// onu bundan dolayı alamıyorda diğerini görmesi lazım
    {
        public DiceLevelAwardInfo[] GetDiceLevelAwardInfos()
        {
            ...
            {
                if (log.IsErrorEnabled) //böyle de çalışır deniyelm bakalm
                {
                    log.Error("GetAllDiceLevelAward", e);
                }
            }
            finally
            {
        ...
        public GmActivityInfo[] GetAllGmActivity()
        {
            ...
            try
            {
                db.GetReader(ref ResultDataReader, "SP_GM_Activity_All");
                while (ResultDataReader.Read())
                {
                    list.Add(InitGmActivityInfo(ResultDataReader));
                }
            }
            catch (Exception exception)
            {
                if (log.IsErrorEnabled)
                {
                  log.Error("InitGmActivityInfo", exception);
                }
            }
            finally
            {
        ...
        public GmActiveConditionInfo[] GetAllGmActiveCondition()
        {
            ...
            try
            {
                db.GetReader(ref ResultDataReader, "SP_GM_Active_Condition_All");
                while (ResultDataReader.Read())
                {
                    list.Add(InitGmActiveConditionInfo(ResultDataReader));
                }
            }
            catch (Exception exception)
            {
                if (log.IsErrorEnabled)
                {
                    log.Error("InitGmActiveConditionInfo", exception);
                }
            }
            finally
            {
        ...
        public GmGiftInfo[] GetAllGmGift()
        {
            ...
            try
            {
                db.GetReader(ref ResultDataReader, "SP_GM_Gift_All");
                while (ResultDataReader.Read())
                {
                    list.Add(InitGmGiftInfo(ResultDataReader));
                }
            }
            catch (Exception exception)
            {
                if (log.IsErrorEnabled)
                {
                    log.Error("InitGmGiftInfo", exception);
                }
            }
            finally
            {
        ...
        public GmActiveRewardInfo[] GetAllGmActiveReward()
        {
            ...
            try
            {
                db.GetReader(ref ResultDataReader, "SP_GM_Active_Reward_All");
                while (ResultDataReader.Read())
                {
                    list.Add(InitGmActiveRewardInfo(ResultDataReader));
                }
            }
            catch (Exception exception)
            {
                if (log.IsErrorEnabled)
                {
                    log.Error("InitGmActiveRewardInfo", exception);
                }
            }
            finally
            {
        ...
        public EventAwardInfo[] GetEventAwardInfos()
        {
            ...
            try
            {
                db.GetReader(ref reader, "SP_EventAwardItem_All");
                while (reader.Read())
                {
        ...
        {
            OldPlayerAwardInfo info = new OldPlayerAwardInfo();
            info.RewardItemID = (int)reader["RewardItemID"];
            info.RewardItemValid = (int)reader["RewardItemValid"];
            info.RewardItemCount = (int)reader["RewardItemCount"];
            info.StrengthenLevel = (int)reader["StrengthenLevel"];
        ...
        public OldPlayerAwardInfo[] GetAllOldPlayerAward()
        {
            ...
            try
            {
                db.GetReader(ref reader, "SP_Get_OldPlayerAward");

                while (reader.Read())
                {
                    infos.Add(InitOldPlayerAward(reader));
                }
            }
            catch (Exception e)
            {
                if (log.IsErrorEnabled)
                    log.Error("GetAllOldPlayerAward", e);
            }
            finally
            {
                if (reader != null && !reader.IsClosed)

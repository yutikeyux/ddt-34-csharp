...
namespace Bussiness.Managers
{
    public class WorldEventMgr
    {
        ...
        private static readonly ThreadSafeRandom random = new();
        ...
        {
            bool flag = false;
            using PlayerBussiness bussiness = new();
            List<ItemInfo> list = [];
            ...
            for (int i = 0; i < list.Count; i += 5)
            {
                ...
                _ = builder.Append(LanguageMgr.GetTranslation("Game.Server.GameUtils.CommonBag.AnnexRemark"));
                int num3 = i;
                if (list.Count > num3)
                {
                    ...
                    if (info6.ItemID == 0)
                    {
                        _ = bussiness.AddGoods(info6);
                    }
                    mail.Annex1 = info6.ItemID.ToString();
                    mail.Annex1Name = info6.Template.Name;
                    _ = builder.Append("1、" + mail.Annex1Name + "x" + info6.Count + ";");
                    _ = builder2.Append("1、" + mail.Annex1Name + "x" + info6.Count + ";");
                }
                num3 = i + 1;
                if (list.Count > num3)
                {
                    ...
                    if (info5.ItemID == 0)
                    {
                        _ = bussiness.AddGoods(info5);
                    }
                    mail.Annex2 = info5.ItemID.ToString();
                    mail.Annex2Name = info5.Template.Name;
                    _ = builder.Append("2、" + mail.Annex2Name + "x" + info5.Count + ";");
                    _ = builder2.Append("2、" + mail.Annex2Name + "x" + info5.Count + ";");
                }
                num3 = i + 2;
                if (list.Count > num3)
                {
                    ...
                    if (info4.ItemID == 0)
                    {
                        _ = bussiness.AddGoods(info4);
                    }
                    mail.Annex3 = info4.ItemID.ToString();
                    mail.Annex3Name = info4.Template.Name;
                    _ = builder.Append("3、" + mail.Annex3Name + "x" + info4.Count + ";");
                    _ = builder2.Append("3、" + mail.Annex3Name + "x" + info4.Count + ";");
                }
                num3 = i + 3;
                if (list.Count > num3)
                {
                    ...
                    if (info3.ItemID == 0)
                    {
                        _ = bussiness.AddGoods(info3);
                    }
                    mail.Annex4 = info3.ItemID.ToString();
                    mail.Annex4Name = info3.Template.Name;
                    _ = builder.Append("4、" + mail.Annex4Name + "x" + info3.Count + ";");
                    _ = builder2.Append("4、" + mail.Annex4Name + "x" + info3.Count + ";");
                }
                num3 = i + 4;
                if (list.Count > num3)
                {
                    ...
                    if (info2.ItemID == 0)
                    {
                        _ = bussiness.AddGoods(info2);
                    }
                    mail.Annex5 = info2.ItemID.ToString();
                    mail.Annex5Name = info2.Template.Name;
                    _ = builder.Append("5、" + mail.Annex5Name + "x" + info2.Count + ";");
                    _ = builder2.Append("5、" + mail.Annex5Name + "x" + info2.Count + ";");
                }
        ...
        {
            List<LuckyStartToptenAwardInfo> infos = [.. m_luckyStartToptenAward.Values];
            return infos;
        }
        ...
        public static List<LuckyStartToptenAwardInfo> GetLuckyStartAwardByRank(int rank)
        {
            ...
            List<LuckyStartToptenAwardInfo> infos = [];
        ...
        public static bool ReLoad()
        {
            try
            {
                Dictionary<int, LuckyStartToptenAwardInfo> templuckyStartToptenAward = [];

    ...
    public class ConsortiaBussiness : BaseBussiness
    {
        ...
        public bool ConsortiaRichRemove(int consortiID, ref int riches)
        {
            ...
            try
            {
                ...
                {
                    new("@ConsortiaID", consortiID),
                    new("@Riches", SqlDbType.Int),
                    null
                };
        ...
        {
            List<ConsortiaBossConfigInfo> list = [];
            SqlDataReader ResultDataReader = null;
            try
            {
                _ = db.GetReader(ref ResultDataReader, "SP_Consortia_Boss_Config_All");
        ...
        public ConsortiaBuffTempInfo[] GetAllConsortiaBuffTemp()
        {
            ...
            try
            {
                _ = db.GetReader(ref ResultDataReader, "SP_Consortia_Buff_Temp_All");
                while (ResultDataReader.Read())
                {
        ...
        public bool AddConsortia(ConsortiaInfo info, ref string msg, ref ConsortiaDutyInfo dutyInfo)
        {
            ...
            try
            {
                ...
                sqlParameters[4] = new SqlParameter("@ChairmanName", info.ChairmanName ?? "");
                sqlParameters[5] = new SqlParameter("@ConsortiaName", info.ConsortiaName ?? "");
                sqlParameters[6] = new SqlParameter("@CreatorID", info.CreatorID);
                sqlParameters[7] = new SqlParameter("@CreatorName", info.CreatorName ?? "");
        ...
        public bool AddConsortiaAlly(ConsortiaAllyInfo info, int userID, ref string msg)
        {
            ...
            try
            {
                ...
                _ = db.RunProcedure("SP_ConsortiaAlly_Add", sqlParameters);
        ...
        public bool AddConsortiaApplyUsers(ConsortiaApplyUserInfo info, ref string msg)
        {
            ...
            try
            {
                ...
                sqlParameters[3] = new SqlParameter("@ConsortiaName", info.ConsortiaName ?? "");
                sqlParameters[4] = new SqlParameter("@IsExist", info.IsExist);
                sqlParameters[5] = new SqlParameter("@Remark", info.Remark ?? "");
                sqlParameters[6] = new SqlParameter("@UserID", info.UserID);
                sqlParameters[7] = new SqlParameter("@UserName", info.UserName ?? "");
                sqlParameters[8] = new SqlParameter("@Result", SqlDbType.Int)
                {
                    Direction = ParameterDirection.ReturnValue
                };
        ...
        public bool AddConsortiaInviteUsers(ConsortiaInviteUserInfo info, ref string msg)
        {
            ...
            try
            {
                ...
                sqlParameters[0].Direction = ParameterDirection.InputOutput;
                sqlParameters[1] = new SqlParameter("@ConsortiaID", info.ConsortiaID);
                sqlParameters[2] = new SqlParameter("@ConsortiaName", info.ConsortiaName ?? "");
                sqlParameters[3] = new SqlParameter("@InviteDate", info.InviteDate);
                sqlParameters[4] = new SqlParameter("@InviteID", info.InviteID);
                sqlParameters[5] = new SqlParameter("@InviteName", info.InviteName ?? "");
                sqlParameters[6] = new SqlParameter("@IsExist", info.IsExist);
                sqlParameters[7] = new SqlParameter("@Remark", info.Remark ?? "");
                sqlParameters[8] = new SqlParameter("@UserID", info.UserID)
                {
                    Direction = ParameterDirection.InputOutput
                };
                sqlParameters[9] = new SqlParameter("@UserName", info.UserName ?? "");
        ...
        public bool BuyBadge(int consortiaID, int userID, ConsortiaInfo info, ref string msg)
        {
            ...
            try
            {
                SqlParameter[] sqlParameters = new SqlParameter[6]
                {
                    new("@ConsortiaID", consortiaID),
                    new("@UserID", userID),
                    new("@BadgeID", info.BadgeID),
                    new("@ValidDate", info.ValidDate),
                    new("@BadgeBuyTime", info.BadgeBuyTime),
                    new("@Result", SqlDbType.Int)
                };
                sqlParameters[5].Direction = ParameterDirection.ReturnValue;
        ...
        public bool ConsortiaFight(int consortiWin, int consortiaLose, int playerCount, out int riches, int state, int totalKillHealth, float richesRate)
        {
            ...
            try
            {
                ...
                {
                    new("@ConsortiaWin", consortiWin),
                    new("@ConsortiaLose", consortiaLose),
        ...
        public bool DeleteConsortia(int consortiaID, int userID, ref string msg)
        {
            ...
            try
            {
                ...
                _ = db.RunProcedure("SP_Consortia_Delete", sqlParameters);
                int num = (int)sqlParameters[2].Value;
                flag = num == 0;
                switch (num)
                {
        ...
        public bool DeleteConsortiaApplyAlly(int applyID, int userID, int consortiaID, ref string msg)
        {
            ...
            try
            {
                ...
                _ = db.RunProcedure("SP_ConsortiaApplyAlly_Delete", sqlParameters);
        ...
        public bool DeleteConsortiaApplyUsers(int applyID, int userID, int consortiaID, ref string msg)
        {
            ...
            try
            {
                ...
                sqlParameters[3].Direction = ParameterDirection.ReturnValue;
                _ = db.RunProcedure("SP_ConsortiaApplyUser_Delete", sqlParameters);
                int num = (int)sqlParameters[3].Value;
                flag = num is 0 or 3;
                if (num == 2)
                {
        ...
        public bool DeleteConsortiaDuty(int dutyID, int userID, int consortiaID, ref string msg)
        {
            ...
            try
            {
                ...
                sqlParameters[3].Direction = ParameterDirection.ReturnValue;
                _ = db.RunProcedure("SP_ConsortiaDuty_Delete", sqlParameters);
                int num = (int)sqlParameters[3].Value;
                flag = num == 0;
                switch (num)
                {
        ...
        public bool DeleteConsortiaInviteUsers(int intiveID, int userID)
        {
            ...
            try
            {
                ...
                sqlParameters[2].Direction = ParameterDirection.ReturnValue;
                _ = db.RunProcedure("SP_ConsortiaInviteUser_Delete", sqlParameters);
                flag = (int)sqlParameters[2].Value == 0;
                return flag;
            }
            catch (Exception exception)
        ...
        public bool DeleteConsortiaUser(int userID, int kickUserID, int consortiaID, ref string msg, ref string nickName)
        {
            ...
            try
            {
                ...
                _ = db.RunProcedure("SP_ConsortiaUser_Delete", sqlParameters);
                int num = (int)sqlParameters[3].Value;
                if (num == 0)
                {
                    flag = true;
        ...
        {
            List<ConsortiaLevelInfo> list = [];
            SqlDataReader resultDataReader = null;
            try
            {
                _ = db.GetReader(ref resultDataReader, "SP_Consortia_Level_All");
                while (resultDataReader.Read())
                {
                    ConsortiaLevelInfo item = new()
                    {
        ...
        {
            List<ConsortiaInfo> list = [];
            SqlDataReader resultDataReader = null;
            try
            {
                _ = db.GetReader(ref resultDataReader, "SP_Consortia_All");
                while (resultDataReader.Read())
                {
                    ConsortiaInfo item = new()
                    {
        ...
        {
            List<ConsortiaAllyInfo> list = [];
            SqlDataReader resultDataReader = null;
            try
            {
                _ = db.GetReader(ref resultDataReader, "SP_ConsortiaAlly_All");
                while (resultDataReader.Read())
                {
                    ConsortiaAllyInfo item = new()
                    {
        ...
        {
            List<ConsortiaApplyAllyInfo> list = [];
            try
            {
                ...
                {
                    ConsortiaApplyAllyInfo item = new()
                    {
                        ID = (int)row["ID"],
        ...
        {
            List<ConsortiaApplyUserInfo> list = [];
            try
            {
                string queryWhere = " IsExist=1 ";
                if (consortiaID != -1)
                ...
                {
                    ConsortiaApplyUserInfo item = new()
                    {
                        ID = (int)row["ID"],
        ...
        public Dictionary<int, int> GetConsortiaByAlly(int consortiaID)
        {
            ...
            try
            {
                ...
                _ = db.GetReader(ref resultDataReader, "SP_Consortia_Ally_Neutral", sqlParameters);
                while (resultDataReader.Read())
                {
        ...
        public int[] GetConsortiaByAllyByState(int consortiaID, int state)
        {
            ...
            try
            {
                ...
                _ = db.GetReader(ref resultDataReader, "SP_Consortia_AllyByState", sqlParameters);
                while (resultDataReader.Read())
                {
        ...
        {
            List<ConsortiaEquipControlInfo> list = [];
            try
            {
                string queryWhere = " IsExist=1 ";
                if (consortiaID != -1)
                ...
                {
                    ConsortiaEquipControlInfo item = new()
                    {
                        ConsortiaID = (int)row["ConsortiaID"],
                        Level = (int)row["Level"],
        ...
        public ConsortiaEquipControlInfo GetConsortiaEquipRiches(int consortiaID, int Level, int type)
        {
            ...
            try
            {
                ...
                _ = db.GetReader(ref resultDataReader, "SP_Consortia_Equip_Control_Single", sqlParameters);
        ...
        {
            List<ConsortiaInviteUserInfo> list = [];
            try
            {
                string queryWhere = " IsExist=1 ";
                if (userID != -1)
                ...
                {
                    ConsortiaInviteUserInfo item = new()
                    {
                        ID = (int)row["ID"],
                        CelebCount = (int)row["CelebCount"],
                        ChairmanName = row["ChairmanName"].ToString(),
        ...
        {
            List<ConsortiaInfo> consortiaInfoList = [];
            try
            {
                string queryWhere = " IsExist=1 ";
                if (!string.IsNullOrEmpty(name))
        ...
        public ConsortiaInfo GetConsortiaSingle(int id)
        {
            ...
            try
            {
                ...
                _ = db.GetReader(ref resultDataReader, "SP_Consortia_Single", sqlParameters);
                if (resultDataReader.Read())
                {
        ...
        public ConsortiaInfo GetConsortiaSingleByName(string ConsortiaName)
        {
            ...
            try
            {
                SqlParameter[] sqlParameters = new SqlParameter[1]
                {
                    new("@ConsortiaName", SqlDbType.NVarChar, 200)
                };
                sqlParameters[0].Value = ConsortiaName;
                _ = db.GetReader(ref resultDataReader, "SP_Consortia_CheckByName", sqlParameters);
                if (resultDataReader.Read())
                {
                    return new ConsortiaInfo
                    {
        ...
        public ConsortiaUserInfo GetConsortiaUsersByUserID(int userID)
        {
            ...
            return infoArray.Length == 1 ? infoArray[0] : null;
        }
        ...
        {
            List<ConsortiaUserInfo> consortiaUserInfoList = [];
            try
            {
                string queryWhere = " IsExist=1 ";
                if (consortiaID != -1)
        ...
        public bool PassConsortiaApplyAlly(int applyID, int userID, int consortiaID, ref int tempID, ref int state, ref string msg)
        {
            ...
            try
            {
                ...
                _ = db.RunProcedure("SP_ConsortiaApplyAlly_Pass", sqlParameters);
                int num = (int)sqlParameters[5].Value;
                if (num == 0)
                {
                    flag = true;
        ...
        public bool PassConsortiaApplyUsers(int applyID, int userID, string userName, int consortiaID, ref string msg, ConsortiaUserInfo info, ref int consortiaRepute)
        {
            ...
            try
            {
                ...
                _ = db.RunProcedure("SP_ConsortiaApplyUser_Pass", sqlParameters);
        ...
        public bool PassConsortiaInviteUsers(int inviteID, int userID, string userName, ref int consortiaID, ref string consortiaName, ref string msg, ConsortiaUserInfo info, ref int tempID, ref string tempName, ref int consortiaRepute)
        {
            ...
            try
            {
                ...
                _ = db.RunProcedure("SP_ConsortiaInviteUser_Pass", sqlParameters);
        ...
        public bool RenameConsortiaName(string userName, string nickName, string consortiaName, ref string msg)
        {
            ...
            try
            {
                SqlParameter[] sqlParameters = new SqlParameter[4]
                {
                    ...
                    new("@ConsortiaName", consortiaName),
                    new("@Result", SqlDbType.Int)
                };
                sqlParameters[3].Direction = ParameterDirection.ReturnValue;
        ...
        public bool ScanConsortia(ref string noticeID)
        {
            ...
            try
            {
                SqlParameter[] sqlParameters = new SqlParameter[2]
                {
                    new("@NoticeID", SqlDbType.NVarChar, 4000),
                    null
                };
        ...
        public bool UpdateConsotiaApplyState(int consortiaID, int userID, bool state, ref string msg)
        {
            ...
            try
            {
                ...
                sqlParameters[3].Direction = ParameterDirection.ReturnValue;
                _ = db.RunProcedure("SP_Consortia_Apply_State", sqlParameters);
                int num = (int)sqlParameters[3].Value;
                flag = num == 0;
                if (num == 2)
                {
        ...
        public bool UpGradeConsortia(int consortiaID, int userID, ref string msg)
        {
            ...
            try
            {
                ...
                sqlParameters[2].Direction = ParameterDirection.ReturnValue;
                _ = db.RunProcedure("SP_Consortia_UpGrade", sqlParameters);
                int num = (int)sqlParameters[2].Value;
                flag = num == 0;
                switch (num)
                {
        ...
        public bool UpGradeShopConsortia(int consortiaID, int userID, ref string msg)
        {
            ...
            try
            {
                ...
                sqlParameters[2].Direction = ParameterDirection.ReturnValue;
                _ = db.RunProcedure("SP_Consortia_Shop_UpGrade", sqlParameters);
                int num = (int)sqlParameters[2].Value;
                flag = num == 0;
                switch (num)
                {
        ...
        public bool UpGradeSkillConsortia(int consortiaID, int userID, ref string msg)
        {
            ...
            try
            {
                ...
                sqlParameters[2].Direction = ParameterDirection.ReturnValue;
                _ = db.RunProcedure("SP_Consortia_Skill_UpGrade", sqlParameters);
                int num = (int)sqlParameters[2].Value;
                flag = num == 0;
                switch (num)
                {
        ...
        public bool UpGradeSmithConsortia(int consortiaID, int userID, ref string msg)
        {
            ...
            try
            {
                ...
                sqlParameters[2].Direction = ParameterDirection.ReturnValue;
                _ = db.RunProcedure("SP_Consortia_Smith_UpGrade", sqlParameters);
                int num = (int)sqlParameters[2].Value;
                flag = num == 0;
                switch (num)
                {
        ...
        public bool UpGradeStoreConsortia(int consortiaID, int userID, ref string msg)
        {
            ...
            try
            {
                ...
                sqlParameters[2].Direction = ParameterDirection.ReturnValue;
                _ = db.RunProcedure("SP_Consortia_Store_UpGrade", sqlParameters);
                int num = (int)sqlParameters[2].Value;
                flag = num == 0;
                switch (num)
                {
        ...
        public ConsortiaInfo[] UpdateConsortiaFightPower()
        {
            ...
            try
            {
                _ = db.GetReader(ref ResultDataReader, "SP_Consortia_Update_FightPower");
                while (ResultDataReader.Read())
                {
                    consortiaInfoList.Add(new ConsortiaInfo
                    {
        ...
        public void RemoveAllConsortiaBattleRank()
        {
            try
            {
                _ = db.RunProcedure("SP_ConsortiaWarRank_RemoveAll");
            }
            catch (Exception e)
            {
                if (log.IsErrorEnabled)
        ...
        public void RemoveAllConsortiaBattlePlayerRank()
        {
            try
            {
                _ = db.RunProcedure("SP_ConsortiaWarPlayerRank_RemoveAll");
            }
            catch (Exception e)
            {
                if (log.IsErrorEnabled)
        ...
        public bool AddConsortiaBattleRank(ConsortiaWarRankInfo guild)
        {
            ...
            try
            {
                ...
                _ = db.RunProcedure("SP_ConsortiaWarRank_Add", para);
        ...
        public bool AddConsortiaBattlePlayerRank(ConsortiaWarPlayerRankInfo player)
        {
            ...
            try
            {
                ...
                _ = db.RunProcedure("SP_ConsortiaWarPlayerRank_Add", para);
        ...
        {
            List<ConsortiaInfo> infos = [];
            SqlDataReader reader = null;
            try
            {
                _ = db.GetReader(ref reader, "SP_Consortia_Rank_Week_Riches");
                while (reader.Read())
                {
                    ConsortiaInfo info = new()
                    {
        ...
        public ConsortiaInfo[] GetRankDayRichesConsortias()
        {
            ...
            try
            {
                _ = db.GetReader(ref reader, "SP_Consortia_Rank_Day_Riches");
                while (reader.Read())
                {
                    ConsortiaInfo info = new()
                    {
        ...
        public ConsortiaInfo[] GetRankDayOnlineConsortias()
        {
            ...
            try
            {
                //Console.WriteLine("GetRankDayOnlineConsortias sorununu çöz");
                _ = db.GetReader(ref reader, "SP_Consortia_Rank_Online");
                while (reader.Read())
                {
                    ConsortiaInfo info = new()
                    {

...
namespace AdminGunny.Admin
{
    ...
    public class mainRequest : System.Web.UI.Page
    {
        ...
        public static string SendMailByAdmin(string title, string content, string UserName, string param)
        {
            ...
            {
                content = "Cảm ơn bạn đã mua vật phẩm từ chúng tôi, chúc bạn chơi game vui vẻ!";
            }
            ...
            try
            {
                ...
                if (player != null)
                {
                    ...
                    if (param == "")
                    {
                        ...
                        mail.Sender = "Thương Nhân Hắc Ám";
                        mail.SenderID = 0;
                        //business.SendMail(mail, agentId);
                        business.SendMail(mail);
                    ...
                    else
                    {
                        ...
                        if (infos.Count > 0)
                        {
                            ...
                            //WorldEventMgr.SendItemsToMail(infos, player.ID, player.NickName, title, "Administrators");
                            WorldEventMgr.SendItemsToMails(infos, player.ID, player.NickName, 1, null, title);
